...
m.showHtml||m["updateTaBindtaTextElement"+B]()},m.$watch("displayElements.html",function(a,b){}),
...
m.$watch("html",function(a,b){a!==b&&(
//console.log('ngModel.$setViewValue', newValue);
o.ngModel&&p.$viewValue!==a&&p.$setViewValue(a),m.displayElements.forminput.val(a))}),o.taTargetToolbars)x=g.registerEditor(m._name,m,o.taTargetToolbars.split(","));else{var F=angular.element('<div text-angular-toolbar name="textAngularToolbar'+B+'">');
