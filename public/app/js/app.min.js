...
c){for(var f=$jscomp.makeIterator(a),e=f.next();!e.done;e=f.next())d(e.value).callWhenSettled_(b,c)})};c.all=function(a){var b=$jscomp.makeIterator(a),f=b.next();return f.done?d([]):new c(function(a,c){function e(b){return function(c){g[b]=c;h--;0==h&&a(g)}}var g=[],h=0;do g.push(void 0),h++,d(f.value).callWhenSettled_(e(g.length-1),c),f=b.next();while(!f.done)})};return c},"es6","es3");
...
"URL_DOCS","APP_PATH","API",function(a,b,d,e){var c=this;c.$onInit=function(){c.app_path=d;c.display_time_estimation=!1;c.devoir.contenu=a.trustAsHtml(c.devoir.contenu);e.get_type_de_devoir(c.devoir.type_devoir_id).then(function(a){c.devoir.type_devoir=a.data});_(c.devoir.ressources).each(function(c){c.url=a.trustAsResourceUrl(b+"/api/connector?cmd\x3dfile\x26target\x3d"+c.hash)})}}]});
...
a.label+"\x3c/h5\x3e";c+=_(a.semaines).map(function(a){var c='\x3cspan class\x3d"week';n.sont_ce_les_vacances(a.semaine,q)&&(c+=" vacances gris2");"1"===b[a.semaine]&&(c+=" active orange-moins");return c+='"\x3e'+a.semaine+"\x3c/span\x3e"}).join("");return c+"\x3c/div\x3e"}).value().join("")+'\x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\x3c/div\x3e'};a.filter_creneau=function(a,b){return function(c){if(!a.display_problems&&!c.ready||!a.display_ready&&c.ready)return!1;c.is_displayed=!0;_(b.classes).isEmpty()&&
...
(c=a.cours.$update(),a.actions_done.push(m.SEQUENCE_PEDAGOGIQUE_MODIFIED)),0<g.length&&c.then(function(a){f(g,a)})):f(g,a.cours)}f(a.devoirs,null)}d.all(b).then(a.fermer)};var D=function(a){};if(!a.creneau.en_creation){a.estimation_over=function(a,b){a.overValue=b;a.minutes=5*b};a.estimation_leave=function(b){a.estimation_over(b,b.temps_estime)};u.query_types_de_devoir().then(function(b){a.types_de_devoir=b.data});D=function(c){a.cours=A.get({id:c.id});a.cours.$promise.then(function(c){a.cours.editable=
_(a.cours.date_validation).isNull()&&_(["ENS","DOC"]).includes(a.current_user.profil_actif.type)&&a.cours.enseignant_id===a.current_user.id;a.cours.editable||(a.cours.contenu=e.trustAsHtml(a.cours.contenu));c.devoirs=_.chain(c.devoirs).select(function(a){return _.chain(w).findWhere({id:a.id}).isUndefined().value()}).map(function(a){return v.get({id:a.id})}).value();_(c.devoirs).each(function(c){c.$promise.then(function(c){a.estimation_leave(c);c.tooltip="\x3cem\x3e"+b("amDateFormat")(c.date_due,"dddd D MMMM YYYY")+
"\x3c/em\x3e\x3chr /\x3e"+c.contenu;0<c.temps_estime&&(c.tooltip='\x3cspan\x3e\x3ci class\x3d"picto temps"\x3e\x3c/i\x3e'+5*c.temps_estime+" minutes\x3c/span\x3e\x3chr /\x3e"+c.tooltip);c.tooltip=e.trustAsHtml("\x3cdiv\x3e"+c.tooltip+"\x3c/div\x3e");a.creneau.etranger&&(c.contenu=e.trustAsHtml(c.contenu))})});d.all(a.devoirs).then(function(){a.cours.devoirs=_(a.cours.devoirs).filter(function(b){return _.chain(a.devoirs).findWhere({id:b.id}).isUndefined().value()})});a.cours.$promise.then(function(){_(a.cours.ressources).each(function(a){a.url=
...
(f=" label-danger");d.prepend('\x3cdiv class\x3d"est-time est-time-'+b.temps_estime+" "+f+'"\x3e\x3c/div\x3e')}b.has_resources&&d.prepend('\x3ci class\x3d"glyphicon glyphicon-paperclip"\x3e\x3c/i\x3e');c=c.find(".fc-list-item-title");if(0<c.length&&(!_(b.details.cours).isNull()||!_(b.details.devoirs).isEmpty())){var g=c.html()+'\n              \x3cbr\x3e\n\x3cdiv class\x3d"col-md-6 sequence-pedagogique"\x3e';_(b.details.cours).isNull()||(g+="\n              \x3cfieldset\x3e\n                \x3clegend\x3eS\u00e9quence p\u00e9dagogique\x3c/legend\x3e\n                "+
...
{id:"@id"},{bulk:{method:"POST",isArray:!0,url:b+"/api/salles/bulk",params:{salles:"@salles"}}})}]).factory("Matchable",["$resource","APP_PATH",function(a,b){return a(b+"/api/matchables/:uai/:hash_item",{uai:"@uai",hash_item:"@hash_item",id_annuaire:"@id_annuaire"})}]);
angular.module("cahierDeTextesClientApp").service("API",["$http","APP_PATH","StatistiquesRegroupements","Cours","CreneauxEmploiDuTemps","Devoirs","EmploisDuTemps","Enseignants","Etablissements",function(a,b,d,e,c,f,g,h,l){this.get_etablissement=function(a){return l.get(a)};this.query_statistiques_regroupements=function(a){return d.query(a)};this.query_types_de_devoir=_.memoize(function(){return a.get(b+"/api/types_de_devoir")});this.get_type_de_devoir=_.memoize(function(c){return a.get(b+"/api/types_de_devoir/"+
c)});this.query_emplois_du_temps=function(){return g.query()};this.get_creneau_emploi_du_temps=function(a){return c.get(a)};this.get_creneaux_emploi_du_temps_similaires=function(c){return a.get(b+"/api/creneaux_emploi_du_temps/"+c.id+"/similaires",{params:{debut:c.debut,fin:c.fin}})};this.query_enseignants=function(a){return h.query(a)};this.get_enseignant=function(a){return h.get(a)};this.get_cours=function(a){return e.get(a)};this.query_devoirs=function(a){return f.query(a)};this.get_devoir=function(a){return f.get(a)}}]);
...
break;case d.SEQUENCE_PEDAGOGIQUE_MODIFIED:b.success("","S\u00e9quence p\u00e9dagogique modifi\u00e9e.");break;case d.SEQUENCE_PEDAGOGIQUE_DELETED:b.success("","S\u00e9quence p\u00e9dagogique supprim\u00e9e.");break;case d.DEVOIR_CREATED:b.success("","Devoir cr\u00e9\u00e9.");break;case d.DEVOIR_MODIFIED:b.success("","Devoir modifi\u00e9.");break;case d.DEVOIR_DELETED:b.success("","Devoir supprim\u00e9.")}});e(a)}).finally(function(){})};this.edition=function(a,b,d,l,k,p,q,m){c({templateUrl:e+"/app/views/popup_edition.html",
controller:"PopupEditionCtrl",resolve:{raw_data:function(){return a},matieres:function(){return b},classes:function(){return d},creneau:function(){return l},cours:function(){return k},devoirs:function(){return p}},backdrop:"static"},q,m)};this.display=function(a,b,d,l,k){c({templateUrl:e+"/app/views/popup_display.html",controller:"PopupDisplayCtrl",resolve:{titre:function(){return a},cours:function(){return b},devoirs:function(){return d}},backdrop:"static"},l,k)}}]);
