...
angular.module("cahierDeTextesClientApp").config(["$stateProvider","$urlRouterProvider",function(a,b){b.otherwise("/");a.state("404",{url:"404",templateUrl:"app/views/404.html"}).state("index",{url:"/",templateUrl:"app/views/index.html",controller:"IndexCtrl",resolve:{auth:["Redirection",function(a){a.doorman("ADM DIR ENS DOC ELV TUT EVS".split(" "))}],current_user:["User",function(a){return a.get_user().then(function(a){return a.data})}]}}).state("emploi_du_temps",{parent:"index",url:"emploi_du_temps",
views:{content:{templateUrl:"app/views/textbook.html",controller:"TextBookCtrl"}}}).state("devoirs",{parent:"index",url:"devoirs",resolve:{auth:["Redirection",function(a){a.doorman(["ELV","TUT"])}]},views:{content:{templateUrl:"app/views/assignements.html",controller:"AssignementsCtrl"}}}).state("import",{parent:"index",url:"import",resolve:{auth:["Redirection",function(a){a.doorman(["DIR","ADM"])}]},views:{content:{templateUrl:"app/views/import.html",controller:"ImportCtrl"}}}).state("enseignants",
{parent:"index",url:"enseignants",resolve:{auth:["Redirection",function(a){a.doorman(["DIR"])}]},views:{content:{templateUrl:"app/views/dashboard_teachers.html",controller:"DashboardTeachersCtrl"}}}).state("enseignant",{parent:"index",url:"enseignants/:enseignant_id",resolve:{auth:["Redirection",function(a){a.doorman(["DIR"])}]},views:{content:{templateUrl:"app/views/dashboard_teacher.html",controller:"DashboardTeacherCtrl"}}}).state("stats",{parent:"index",url:"stats",resolve:{auth:["Redirection",
function(a){a.doorman(["ENS","DOC"])}]},views:{content:{templateUrl:"app/views/dashboard_teacher.html",controller:"DashboardTeacherCtrl"}}})}]).run(["$rootScope","log",function(a,b){a.$on("$stateChangeSuccess",function(a,e,c,f,g){b.add("CTXT",null,null)})}]);
...
a.enseignant.prof_principal=_.chain(a.enseignant.groups).where({type:"PRI"}).pluck("group_id").map(function(b){return _(a.enseignant.liste_regroupements).findWhere({id:b})}).value();a.select_all_regroupements()});a.enseignant.get_actual_subjects().then(function(b){a.enseignant.liste_matieres=_.chain(b).uniq(function(a){return a.id}).compact().value()});return h.get_enseignant({enseignant_id:a.enseignant_id,uai:a.current_user.profil_actif.structure_id}).$promise}).then(function(b){var c=f().subtract(2,
"weeks");a.raw_data=_(b.saisies).map(function(b,d){b.index=d;b.cours=new l(b.cours);b.regroupement_id=parseInt(b.regroupement_id);b.month=f(b.cours.date_cours).month();b.recent=f(b.cours.date_cours).isAfter(c);b.matiere=_(a.enseignant.liste_matieres).findWhere({id:b.matiere_id});_(b.matiere).isUndefined()&&(b.matiere=k.get_subject(b.matiere_id));b.group=_(a.enseignant.liste_regroupements).findWhere({id:b.regroupement_id});_(b.group).isUndefined()&&k.get_group(b.regroupement_id).then(function(a){b.group=
...
angular.module("cahierDeTextesClientApp").controller("ImportCtrl",["$scope","$http","$locale","$sce","$filter","fileUpload","moment","toastr","$q","APP_PATH","SEMAINES_VACANCES","ZONE","VERSION","Annuaire","Utils","Etablissements","CreneauxEmploiDuTemps","API","Matchable","current_user",function(a,b,d,e,c,f,g,h,l,k,p,q,m,y,n,u,z,A,v,B){a.scope=a;a.jours_de_la_semaine=d.DATETIME_FORMATS.DAY;a.annee=d.DATETIME_FORMATS.MONTH;a.fichier=null;a.display_all=!1;a.step=0;a.report={};a.ui={show_detailed_creneaux:!1,
...
_(d).isUndefined()?0:d.creneaux_emploi_du_temps.vides.length+d.creneaux_emploi_du_temps.pleins.length;c.edit||(c.laclasse.displayed_label=c.laclasse.libelle_aaf)});h.info("traitement des donn\u00e9es des cours");a.creneaux=_.chain(a.pronote.Cours[0].Cours).map(function(b){return _.chain(b.Matiere).map(function(c){var d=function(d){return function(f){var t=angular.copy(b);t.is_displayed=!0;t.Matiere=c;"Classe"===d?(t.Classe=f,t.Classe.Semaines=n.fix_semainier_pronote(t.Classe.Semaines,a.pronote.AnneeScolaire[0].DateDebut)):
...
classes:_(a.pronote.Classes[0].Classe).where({existing_creneaux:0}),groupes:_(a.pronote.Groupes[0].Groupe).where({existing_creneaux:0})};C();a.$watchCollection("selected",function(){r()})},c).then(function(b){a.step++;return l.resolve(!0)},c)},H=function(){g();var c=null,d=function(a){return l.reject(a)};a.report={};var f=_(a.creneaux).select(function(a){return a.ready&&a.is_displayed});return b.post(k+"/api/import/log/start/?uai\x3d"+a.pronote.UAI,{uai:a.pronote.UAI,type:"client "+m,comment:""}).then(function(b){c=
...
fin_annee_scolaire:new Date(a.pronote.AnneeScolaire[0].DateFin)}}).value()};var d=c(a.pronote.classes);d.push(c(a.pronote.groupes_eleves));d=_(d).flatten();return b.post(k+"/api/cahiers_de_textes/bulk",{cahiers_de_textes:d})},d).then(function(c){a.report.cahiers_de_textes=c.data;h.info("Cr\u00e9ation des salles");c=_(a.pronote.salles).map(function(b){return{uai:a.pronote.UAI,identifiant:b.Ident,nom:b.Nom}});return b.post(k+"/api/salles/bulk",{salles:c})},d).then(function(d){a.report.salles=d.data;
...
preConfirm:function(){return new Promise(function(b){x(a).then(function(a){swal.closeModal()},function(a){console.log(a);swal.closeModal();swal({title:"Erreur :(",text:a.data.error,type:"error"})})})},allowOutsideClick:!1})};a.validate_matches=function(){a.step++};a.process_import=function(){swal({title:"Import des donn\u00e9es...",text:"traitement en cours",type:"info",showLoaderOnConfirm:!0,allowOutsideClick:!1,onOpen:function(){swal.clickConfirm()},preConfirm:function(){return new Promise(function(b){H().then(function(b){swal.closeModal();
...
angular.module("cahierDeTextesClientApp").controller("PopupDisplayCtrl",["$scope","$sce","$uibModalInstance","toastr","APP_PATH","Cours","Devoirs","User","titre","cours","devoirs",function(a,b,d,e,c,f,g,h,l,k,p){a.app_path=c;a.matiere=l;a.date=null;_(k).isNull()||(a.cours=new f(k),a.date=a.cours.date_cours,_(k.devoirs).each(function(a){a.tooltip=a.contenu;0<a.temps_estime&&(a.tooltip='\x3cspan\x3e\x3ci class\x3d"picto temps"\x3e\x3c/i\x3e'+5*a.temps_estime+" minutes\x3c/span\x3e\x3chr\x3e"+a.tooltip);
a.tooltip=b.trustAsHtml(a.tooltip)}));a.devoirs=p.map(function(a){a.matiere=l;return new g(a)});_(a.date).isNull()&&!_(a.devoirs).isEmpty()&&(a.date=a.devoirs[0].date_due);a.fermer=function(){d.close(a)};h.get_user().then(function(b){a.current_user=b.data})}]);
angular.module("cahierDeTextesClientApp").controller("PopupEditionCtrl",["$scope","$filter","$q","$sce","$uibModalInstance","$locale","toastr","moment","APP_PATH","URL_DOCS","SEMAINES_VACANCES","ZONE","POPUP_ACTIONS","LOCALHOST","Documents","API","CreneauxEmploiDuTemps","Cours","Devoirs","User","Utils","cours","devoirs","creneau","raw_data","classes","matieres",function(a,b,d,e,c,f,g,h,l,k,p,q,m,y,n,u,z,A,v,B,r,C,w,x,H,I,J){a.scope=a;a.correctTimeZoneToGMT=function(a){var b=(new Date(a)).getTimezoneOffset()/
60;a.setHours(a.getHours()+b);return a};a.app_path=l;a.ZONE=q;a.jours=_(f.DATETIME_FORMATS.DAY).indexBy(function(a){return _(f.DATETIME_FORMATS.DAY).indexOf(a)});a.classes=I;a.matieres=_(J).sortBy("name");a.faulty_docs_app=!1;a.erreurs=[];a.dirty=!1;a.mode_duplication=!1;a.actions_done=[];a.creneau=x;a.creneau.jour_de_la_semaine=""+a.creneau.jour_de_la_semaine;a.mode_edition_creneau=a.creneau.en_creation;a.creneau.regroupement_id=parseInt(a.creneau.regroupement_id);a.creneau.previous_regroupement_id=
...
a.hash)});a.creneau.etranger&&(b.contenu=e.trustAsHtml(b.contenu))})});a.set_creneau_date_due=function(b){var c=_(a.creneaux_devoirs_possibles).findWhere({date_due:b.date_due});b.creneau_emploi_du_temps_id=c.id;a.is_dirty(b)};var E=function(a,b,c){return u.get_creneaux_emploi_du_temps_similaires({id:a.id,debut:h(a.heure_debut.toISOString()).subtract(b,"weeks").toDate(),fin:h(a.heure_debut.toISOString()).add(c,"weeks").toDate()})};E(a.creneau,2,8).then(function(b){a.creneaux_devoirs_possibles_duplication=
...
_(a.classes).findWhere({id:parseInt(c.regroupement_id)});c.semaine=h(c.start).from(h(a.creneau.heure_debut));c.heure_debut=new Date(c.heure_debut);c.heure_fin=new Date(c.heure_fin);c.date_due=b("date")(c.heure_debut,"y-MM-dd");return c}).sortBy(function(a){return a.start}).value();1<a.creneaux_devoirs_possibles.length&&(a.creneaux_devoirs_possibles=_(a.creneaux_devoirs_possibles).select(function(b){return b.heure_debut.toISOString()!=a.creneau.heure_debut.toISOString()}))});a.cartable={};a.cartable.expandedNodes=
[];a.treeOptions={dirSelectable:!1};n.list_files().then(function(b){_(b.data).has("files")&&(a.cartable=b.data,a.cartable.files=_(b.data.files).select(function(a){return _(a.phash).isNull()}),a.cartable.expandedNodes=[])},function(){});a.consume_Documents_response_callback=function(b){return function(c){a.erreurs=[];if(_(c.error).isEmpty()){var d=_(c.added).first();b.ressources.push({name:d.name,hash:d.hash,url:e.trustAsResourceUrl(k+"/api/connector?cmd\x3dfile\x26target\x3d"+d.hash)});a.is_dirty(b);
...
!0)};a.creneau_cible_duplication_SP_updated=function(){E(a.creneaux_similaires.selected,0,4).then(function(c){a.creneaux_devoirs_possibles_duplication=_.chain(c.data).select(function(b){return b.regroupement_id==a.creneaux_similaires.selected.regroupement_id}).map(function(c){c.classe=_(a.classes).findWhere({id:parseInt(c.regroupement_id)});c.date_due=b("date")(c.start,"y-MM-dd");c.semaine=h(c.start).from(h(a.creneau.heure_debut),!0)+" plus tard";c.heure_debut=new Date(c.heure_debut);c.heure_fin=
...
a.current_user.get_actual_subjects().then(function(d){k.edition(a.raw_data,d,a.current_user.actual_groups,c,b.details.cours,b.details.devoirs,z,!1)})}):(0<b.details.devoirs.length||!_(b.details.cours).isNull()&&_(b.details.cours).has("contenu"))&&k.display(b.matiere,b.details.cours,b.details.devoirs,z,!1)},select:function(c,d,f){if(a.calendar.options.selectable&&a.calendar.options.editable&&0<a.selected_regroupements.length){18E5===d-c&&(d=b(d).add(30,"minutes").toDate());c=new Date(c);d=new Date(d);
...
angular.module("cahierDeTextesClientApp").service("PopupsCreneau",["$uibModal","toastr","POPUP_ACTIONS",function(a,b,d){var e=function(c,f,g){a.open(c).result.then(function(a){_(a.actions_done).each(function(a){switch(a){case d.CANCELLED:b.info("","Annulation.");break;case d.CRENEAU_DELETED:b.info("","Cr\u00e9neau supprim\u00e9.");break;case d.CRENEAU_MODIFIED:b.info("","Cr\u00e9neau mis \u00e0 jour.");break;case d.SEQUENCE_PEDAGOGIQUE_CREATED:b.success("","S\u00e9quence p\u00e9dagogique cr\u00e9\u00e9e.");
break;case d.SEQUENCE_PEDAGOGIQUE_MODIFIED:b.success("","S\u00e9quence p\u00e9dagogique modifi\u00e9e.");break;case d.SEQUENCE_PEDAGOGIQUE_DELETED:b.success("","S\u00e9quence p\u00e9dagogique supprim\u00e9e.");break;case d.DEVOIR_CREATED:b.success("","Devoir cr\u00e9\u00e9.");break;case d.DEVOIR_MODIFIED:b.success("","Devoir modifi\u00e9.");break;case d.DEVOIR_DELETED:b.success("","Devoir supprim\u00e9.")}});f(a)}).finally(function(){})};this.edition=function(a,b,d,h,l,k,p,q){e({templateUrl:"app/views/popup_edition.html",
controller:"PopupEditionCtrl",resolve:{raw_data:function(){return a},matieres:function(){return b},classes:function(){return d},creneau:function(){return h},cours:function(){return l},devoirs:function(){return k}},backdrop:"static"},p,q)};this.display=function(a,b,d,h,l){e({templateUrl:"app/views/popup_display.html",controller:"PopupDisplayCtrl",resolve:{titre:function(){return a},cours:function(){return b},devoirs:function(){return d}},backdrop:"static"},h,l)}}]);
...
"0",2)}}]);angular.module("cahierDeTextesClientApp").service("log",["$http","$state","APP_PATH","User","URL_ENT",function(a,b,d,e,c){this.add=function(f,g,h){e.get_user().then(function(e){e=e.data;a.post(c+"/api/logs",{application_id:f,user_id:e.id,structure_id:e.profil_actif.structure_id,profil_id:e.profil_actif.type,url:(_(g).isNull()?d+b.current.url:g).substr(0,1023),params:_(h).isNull()?_(b.params).map(function(a,b){return b+"\x3d"+a}).join("\x26"):h}).then(function(){},function(){})})}}]);
...
angular.module("cahierDeTextesClientApp").service("API",["$http","APP_PATH","StatistiquesRegroupements","Cours","CreneauxEmploiDuTemps","Devoirs","EmploisDuTemps","Enseignants","Etablissements","TypesDeDevoir",function(a,b,d,e,c,f,g,h,l,k){this.get_etablissement=function(a){return l.get(a)};this.query_statistiques_regroupements=function(a){return d.query(a)};this.query_types_de_devoir=_.memoize(function(){return k.query()});this.get_type_de_devoir=_.memoize(function(a){return k.get({id:a})});this.query_emplois_du_temps=
function(){return g.query()};this.get_creneau_emploi_du_temps=function(a){return c.get(a)};this.get_creneaux_emploi_du_temps_similaires=function(c){return a.get(b+"/api/creneaux_emploi_du_temps/"+c.id+"/similaires?debut\x3d"+c.debut.toISOString()+"\x26fin\x3d"+c.fin.toISOString())};this.query_enseignants=function(a){return h.query(a)};this.get_enseignant=function(a){return h.get(a)};this.get_cours=function(a){return e.get(a)};this.query_devoirs=function(a){return f.query(a)};this.get_devoir=function(a){return f.get(a)}}]);
angular.module("cahierDeTextesClientApp").service("Documents",["$http","$q","URL_DOCS","Annuaire",function(a,b,d,e){var c=this;c.list_files=_.memoize(function(b){var c={cmd:"open",target:""};void 0==b?c.tree=1:c.target=b;return a.get(d+"/api/connector",{params:c})});c.get_ctxt_folder_hash=_.memoize(function(a){var b,d,f,k,p;return e.get_structure(a.structure_id).then(function(a){b=a.data;return c.list_files()}).then(function(a){d=_(a.data.files).findWhere({phash:null,name:b.name});return c.list_files(d.hash)}).then(function(a){f=
_(a.data.files).findWhere({phash:d.hash,name:"classes"});return c.list_files(f.hash)}).then(function(b){k=_(b.data.files).findWhere({phash:f.hash,name:a.name});return c.list_files(k.hash)}).then(function(a){p=_(a.data.files).findWhere({phash:k.hash,name:"Cahier de textes.ct"});return p.hash})});c.ajout_au_cahier_de_textes=function(b,e){return c.get_ctxt_folder_hash(b).then(function(b){return a.get(d+"/api/connector",{params:{cmd:"paste","targets[]":e.hash,"renames[]":e.name,dst:b,cut:!1}})}).then(function(a){return a.data})};
c.upload_dans_cahier_de_textes=function(e,g){return c.get_ctxt_folder_hash(e).then(function(c){return b.all(_(g).map(function(b){var e=new FormData;e.append("cmd","upload");e.append("target",c);e.append("upload[]",b);e.append("renames[]",b.name);return a.post(d+"/api/connector",e,{headers:{"Content-Type":void 0},transformRequest:angular.identity})})).then(function(a){return a})})}}]);angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/404.html","\x3cem\x3eVotre profil actuel ne vous permet pas d'acc\u00e9der au Cahier de Textes.\x3c/em\x3e\n")}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/assignements.html",'\x3cdiv class\x3d"panel panel-default"\n     ng:swipe-left\x3d"decr_offset()"\n     ng:swipe-right\x3d"incr_offset()"\x3e\n    \x3cdiv class\x3d"panel-heading"\x3e\n        \x3cdiv class\x3d"row col-md-12"\x3e\n            \x3ch2\x3e\n                Du {{from_date | amDateFormat:\'Do MMMM YYYY\'}} au {{to_date | amDateFormat:\'Do MMMM YYYY\'}}\n            \x3c/h2\x3e\n        \x3c/div\x3e\n\n        \x3cdiv class\x3d"row col-md-12"\x3e\n            \x3cselect class\x3d"pull-left"\n                    ng:options\x3d"matiere as matiere.name for (id,matiere) in matieres"\n                    ng:model\x3d"matiere_selected"\n                    ng:change\x3d"filter_data( matiere_selected )"\x3e\n                \x3coption value\x3d"" selected\x3eToutes les mati\u00e8res\x3c/option\x3e\n            \x3c/select\x3e\n\n            \x3cselect class\x3d"pull-left"\n                    ng:model\x3d"period_offset"\n                    ng:options\x3d"period.offset as period.label for period in period_offsets_list"\x3e\n            \x3c/select\x3e\n            \x3cbutton class\x3d"btn btn-default" ng:click\x3d"incr_offset()"\x3e\x3cspan class\x3d"glyphicon glyphicon-chevron-left" aria-hidden\x3d"true"\x3e\x3c/span\x3e\x3c/button\x3e\n            \x3cbutton class\x3d"btn btn-default" ng:click\x3d"decr_offset()"\x3e\x3cspan class\x3d"glyphicon glyphicon-chevron-right" aria-hidden\x3d"true"\x3e\x3c/span\x3e\x3c/button\x3e\n\n            \x3cdiv class\x3d"pull-right options"\x3e\n                \x3clabel\x3e\x3ccheckbox ng:model\x3d"affiche_faits"\x3e\x3c/checkbox\x3e Afficher les devoirs d\u00e9j\u00e0 faits\x3c/label\x3e\n                \x3clabel\x3e\x3ccheckbox ng:model\x3d"tri_ascendant"\x3e\x3c/checkbox\x3e Tri ascendant\x3c/label\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n    \x3c/div\x3e\n\x3c/div\x3e\n\x3cul class\x3d"list-group todo-list" ng:if\x3d"devoirs"\x3e\n    \x3cli ng:repeat\x3d"devoir in devoirs | orderBy:\'date_due\':tri_ascendant"\n        ng:if\x3d"devoir.date_fait \x3d\x3d null || affiche_faits"\n        style\x3d"list-style:none"\n        class\x3d"devoir list-group-item" \x3e\n\n        \x3cdiv class\x3d"row alert alert-default title"\x3e\n            \x3cdiv class\x3d"pull-left date"\x3e{{devoir.date_due | amDateFormat: \'dddd D MMMM\'}}\x3c/div\x3e\n        \x3c/div\x3e\n\n        \x3cdiv class\x3d"row contenu"\x3e\n            \x3cdisplay-devoir class\x3d"col-md-5 alert alert-default"\n                            devoir\x3d"devoir"\x3e\x3c/display-devoir\x3e\n\n            \x3cdisplay-sequence-pedagogique class\x3d"col-md-5 alert alert-default"\n                                          ng:if\x3d"devoir.cours.contenu !\x3d\x3d \'\'"\n                                          sp\x3d"devoir.cours"\x3e\x3c/display-sequence-pedagogique\x3e\n\n            \x3cdiv class\x3d"col-md-2 pull-right todo"\x3e\n                \x3cswitch-devoir devoir\x3d"devoir"\n                               ng:if\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'ELV\'" \x3e\x3c/switch-devoir\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n\n        \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n    \x3c/li\x3e\n\x3c/ul\x3e\n\x3cspan class\x3d"no-data" ng:if\x3d"devoirs.length \x3d\x3d\x3d 0"\x3e\n    Aucun devoir trouv\u00e9 pour cette p\u00e9riode.\n\x3c/span\x3e\n')}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/dashboard_teacher.html",'\x3cdiv class\x3d"panel panel-default"\x3e\n    \x3cdiv class\x3d"panel-heading"\x3e\n        \x3cdiv class\x3d"row"\x3e\n            \x3ca class\x3d"btn btn-info pull-left" ui:sref\x3d"enseignants" ng:if\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'DIR\'" \x3e\u2190 Retour \u00e0 la liste des enseignants\x3c/a\x3e\n        \x3c/div\x3e\n    \x3c/div\x3e\n\n    \x3cdiv class\x3d"panel-body"\x3e\n        \x3ch4 class\x3d"col-md-12 pull-left"\x3e{{enseignant.firstname}} {{enseignant.lastname}}\x3c/h4\x3e\n        \x3cdiv class\x3d"col-md-4"\x3e\n            \x3cdiv class\x3d"panel panel-default"\x3e\n                \x3cdiv class\x3d"panel-body"\x3e\n                    \x3clegend ng:repeat\x3d"email in enseignant.emails"\x3e\n                        \x3cspan class\x3d"glyphicon glyphicon-envelope"\x3e\x3c/span\x3e\n                        \x3ca class\x3d"email" href\x3d"mailto:{{email.address}}"\n                           ng:style\x3d"{\'font-size\': email.primary ? \'inherit\' : \'75%\'}"\x3e{{email.address}}\x3c/a\x3e\n                    \x3c/legend\x3e\n\n                    \x3cfieldset\x3e\n                        \x3clegend\x3e\x3cspan class\x3d"glyphicon glyphicon-briefcase"\x3e\x3c/span\x3e Mati\u00e8res enseign\u00e9es\x3c/legend\x3e\n                        \x3cspan class\x3d"label label-primary pull-left" ng:repeat\x3d"matiere in enseignant.liste_matieres"\x3e{{matiere.name}}\x3c/span\x3e\n                    \x3c/fieldset\x3e\n\n                    \x3cfieldset\x3e\n                        \x3clegend\x3e\x3cspan class\x3d"glyphicon glyphicon-envelope"\x3e\x3c/span\x3e Classes et Groupes\x3c/legend\x3e\n                        \x3cspan class\x3d"label pull-left"\n                              ng:class\x3d"{\'label-success\': regroupement.type \x3d\x3d\x3d \'GRP\', \'label-info\': regroupement.type \x3d\x3d\x3d \'CLS\', \'label-warning\': regroupement.type \x3d\x3d\x3d \'GPL\' }"\n                              ng:repeat\x3d"regroupement in enseignant.liste_regroupements"\x3e{{regroupement.name}}\x3c/span\x3e\n                    \x3c/fieldset\x3e\n\n                    \x3cfieldset ng:if\x3d"enseignant.prof_principal.length \x3e 0"\x3e\n                        \x3clegend\x3e\x3cspan class\x3d"glyphicon glyphicon-bell"\x3e\x3c/span\x3e Professeur principal de\x3c/legend\x3e\n                        \x3cspan class\x3d"label label-info pull-left" ng:repeat\x3d"regroupement in enseignant.prof_principal"\x3e{{regroupement.name}}\x3c/span\x3e\n                    \x3c/fieldset\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"col-md-8"\x3e\n            \x3cdiv class\x3d"panel panel-default"\x3e\n                \x3cdiv class\x3d"panel-body row"\x3e\n                    \x3cnvd3 data\x3d"graphiques.pieChart.data" options\x3d"graphiques.pieChart.options"\x3e\x3c/nvd3\x3e\n                    \x3cnvd3 data\x3d"graphiques.multiBarChart.data" options\x3d"graphiques.multiBarChart.options"\x3e\x3c/nvd3\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n    \x3c/div\x3e\n\x3c/div\x3e\n\n\x3cdiv class\x3d"panel panel-default"\x3e\n    \x3cdiv class\x3d"panel-heading"\x3e\n        \x3cdiv class\x3d"row"\x3e\n            \x3cdiv class\x3d"col-md-9"\x3e\n                \x3cdiv class\x3d"ui-select-wrapper"\x3e\n                    \x3cui-select multiple class\x3d"pull-left" theme\x3d"bootstrap"\n                               append-to-body\x3d"true"\n                               ng:if\x3d"enseignant.liste_regroupements.length \x3e 0"\n                               ng:change\x3d"graphiques.populate( raw_data )"\n                               ng:model\x3d"scope.selected_regroupements"\x3e\n                        \x3cui-select-match placeholder\x3d"Regroupement(s)..."\x3e\n                            \x3cspan class\x3d"label" ng:class\x3d"{\'label-success\': $item.type \x3d\x3d\x3d \'GRP\', \'label-info\': $item.type \x3d\x3d\x3d \'CLS\', \'label-warning\': $item.type \x3d\x3d\x3d \'GPL\' }"\x3e\n                                {{$item.name}}\n                            \x3c/span\x3e\n                        \x3c/ui-select-match\x3e\n                        \x3cui-select-choices repeat\x3d"regroupement in enseignant.liste_regroupements | orderBy:[\'type\',\'name\']"\n                                           group-by\x3d"\'full_type\'"\x3e\n                            {{regroupement.name}}\n                        \x3c/ui-select-choices\x3e\n                    \x3c/ui-select\x3e\n                    \x3cbutton class\x3d"btn btn-xs btn-primary"\n                            ng:click\x3d"select_all_regroupements()"\x3e\x3cspan class\x3d"glyphicon glyphicon-certificate"\x3e\x3c/span\x3e\x3c/button\x3e\n                    \x3cbutton class\x3d"btn btn-xs btn-default"\n                            ng:click\x3d"select_no_regroupements()"\x3e\x3cspan class\x3d"glyphicon glyphicon-erase"\x3e\x3c/span\x3e\x3c/button\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n            \x3cselect class\x3d"col-md-3"\n                    ng:model\x3d"moisCourant"\n                    ng:change\x3d"graphiques.populate( raw_data )"\n                    ng:options\x3d"mois.indexOf(m)+1 as m for m in mois"\x3e\n                \x3coption value\x3d""\x3eToute l\'ann\u00e9e\x3c/option\x3e\n            \x3c/select\x3e\n        \x3c/div\x3e\n\n        \x3clabel\x3e\n            \x3ccheckbox class\x3d"btn-success"\n                      ng:model\x3d"scope.montre_valides"\x3e\x3c/checkbox\x3e\n            afficher les saisies vis\u00e9es\n        \x3c/label\x3e\n\n        \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n    \x3c/div\x3e\n    \x3cdiv class\x3d"panel-body"\x3e\n        \x3ctable class\x3d"table"\x3e\n            \x3cthead\x3e\n                \x3ctr\x3e\n                    \x3cth style\x3d"width:12em;"\x3eDate\x3c/th\x3e\n                    \x3cth style\x3d"width:12em;"\x3eClasse / Groupe\x3c/th\x3e\n                    \x3cth style\x3d"width:12em;"\x3eMati\u00e8re\x3c/th\x3e\n                    \x3cth\x3eCours\x3c/th\x3e\n                    \x3cth\x3eTravail \u00e0 faire\x3c/th\x3e\n                    \x3cth\x3e\n                        \x3cbutton class\x3d"btn btn-warning pull-right"\n                                ng:class\x3d"{\'disabled\': nb_saisies_visables \x3c 1 }"\n                                ng:if\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'DIR\'"\n                                ng:click\x3d"valide_all()"\x3e\n                            \x3cspan class\x3d"glyphicon glyphicon-check"\x3e\x3c/span\x3e Viser la totalit\u00e9\n                        \x3c/button\x3e\n                    \x3c/th\x3e\n                \x3c/tr\x3e\n            \x3c/thead\x3e\n            \x3ctbody\x3e\n                \x3ctr ng:repeat\x3d"saisie in raw_data | filter:filter_saisie( montre_valides, moisCourant, selected_regroupements ) | orderBy:\'cours.date_cours\'"\n                    ng:class\x3d"{\'even\': $even, \'odd\': $odd, \'recent\': saisie.recent \x26\x26 current_user.profil_actif.type \x3d\x3d\x3d \'DIR\' }"\x3e\n                    \x3ctd\x3e{{saisie.cours.date_cours | amDateFormat:\'Do MMMM YYYY\'}}\x3c/td\x3e\n                    \x3ctd ng:bind\x3d"saisie.group.name"\x3e\x3c/td\x3e\n                    \x3ctd ng:bind\x3d"saisie.matiere.name"\x3e\x3c/td\x3e\n                    \x3ctd\x3e\n                        \x3cdiv class\x3d"alert alert-default" ng:bind-html\x3d"saisie.cours.contenu"\x3e\x3c/div\x3e\n                    \x3c/td\x3e\n                    \x3ctd\x3e\n                        \x3cdiv class\x3d"alert alert-default" ng:repeat\x3d"devoir in saisie.devoirs" ng:bind-html\x3d"devoir.contenu"\x3e\x3c/div\x3e\n                    \x3c/td\x3e\n                    \x3ctd\x3e\n                        \x3cspan switch\n                              class\x3d"violet"\n                              disabled\x3d"current_user.profil_actif.type !\x3d\x3d \'DIR\' || saisie.recent"\n                              ng:disabled\x3d"current_user.profil_actif.type !\x3d\x3d \'DIR\' || saisie.recent"\n                              ng:model\x3d"saisie.valide"\n                              ng:change\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'DIR\' \x26\x26 !saisie.recent \x26\x26 valide( saisie )" \x3e\n                        \x3c/span\x3e\n                    \x3c/td\x3e\n                \x3c/tr\x3e\n            \x3c/tbody\x3e\n        \x3c/table\x3e\n    \x3c/div\x3e\n\x3c/div\x3e\n')}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/dashboard_teachers.html",'\x3cdiv class\x3d"panel panel-default"\x3e\n    \x3cdiv class\x3d"panel-heading"\x3e\n        \x3cdiv class\x3d"row"\x3e\n            \x3cdiv class\x3d"ui-select-wrapper"\x3e\n                \x3cui-select multiple class\x3d"pull-left" theme\x3d"bootstrap"\n                           append-to-body\x3d"true"\n                           ng:change\x3d"filter_data()"\n                           ng:model\x3d"scope.selected_regroupements"\x3e\n                    \x3cui-select-match placeholder\x3d"Regroupement(s)..."\x3e\n                        \x3cspan class\x3d"label" ng:class\x3d"{\'label-success\': $item.type \x3d\x3d\x3d \'GRP\', \'label-info\': $item.type \x3d\x3d\x3d \'CLS\', \'label-warning\': $item.type \x3d\x3d\x3d \'GPL\' }"\x3e\n                            {{$item.name}}\n                        \x3c/span\x3e\n                    \x3c/ui-select-match\x3e\n                    \x3cui-select-choices repeat\x3d"regroupement in regroupements | orderBy:[\'type\',\'name\']"\n                                       group-by\x3d"\'full_type\'"\x3e\n                        \x3cspan class\x3d"label" ng:class\x3d"{\'label-success\': regroupement.type \x3d\x3d\x3d \'GRP\', \'label-info\': regroupement.type \x3d\x3d\x3d \'CLS\', \'label-warning\': regroupement.type \x3d\x3d\x3d \'GPL\' }"\x3e\n                            {{regroupement.name}}\n                        \x3c/span\x3e\n                    \x3c/ui-select-choices\x3e\n                \x3c/ui-select\x3e\n                \x3cbutton class\x3d"btn btn-xs btn-primary"\n                        ng:click\x3d"select_all_regroupements()"\x3e\x3cspan class\x3d"glyphicon glyphicon-certificate"\x3e\x3c/span\x3e\x3c/button\x3e\n                \x3cbutton class\x3d"btn btn-xs btn-default"\n                        ng:click\x3d"select_no_regroupements()"\x3e\x3cspan class\x3d"glyphicon glyphicon-erase"\x3e\x3c/span\x3e\x3c/button\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n\n    \x3c/div\x3e\n\x3c/div\x3e\n\n\x3cdiv class\x3d"col-xs-12 col-sm-6 col-md-3 col-lg-3 bloc-enseignant"\n     ng:repeat\x3d"chart in individualCharts.enseignants | orderBy:\'enseignant.details.lastname\'"\n     ng:if\x3d"chart.display"\x3e\n    \x3cdiv class\x3d"panel panel-default"\x3e\n        \x3cdiv class\x3d"panel-heading"\x3e\n            \x3ch4\x3e\n                \x3ca ui:sref\x3d"enseignant({ enseignant_id: chart.enseignant.details.id })"\x3e\n                    {{chart.enseignant.details.firstname}} {{chart.enseignant.details.lastname}}\n                \x3c/a\x3e\n            \x3c/h4\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"panel-body"\x3e\n            \x3cspan ng:if\x3d"chart.pieChart.data[0].value + chart.pieChart.data[1].value \x3d\x3d 0"\x3e\n                Aucune saisie \u00e0 ce jour.\n            \x3c/span\x3e\n            \x3cnvd3 data\x3d"chart.pieChart.data" options\x3d"chart.pieChart.options"\n                  ng:if\x3d"chart.pieChart.data[0].value + chart.pieChart.data[1].value \x3e 0"\x3e\n            \x3c/nvd3\x3e\n        \x3c/div\x3e\n    \x3c/div\x3e\n\x3c/div\x3e\n')}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/import.html",'\x3cuib-tabset justified\x3d"true" active\x3d"step"\x3e\n    \x3cuib-tab index\x3d"0" select\x3d"step \x3d 0"\x3e\n        \x3cuib-tab-heading\x3e\x3ch1\x3e1. Charger un fichier Pronote,\x3c/h1\x3e\x3c/uib-tab-heading\x3e\n\n        \x3cdiv class\x3d"panel panel-default col-md-3"\x3e\n            \x3cdiv class\x3d"panel-heading"\x3eexplications\x3c/div\x3e\n            \x3cdiv class\x3d"panel-body"\x3e\n                D\'abord il faut charger un fichier export\u00e9 depuis Pronote.\n            \x3c/div\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"panel panel-default col-md-9"\x3e\n            \x3cdiv class\x3d"panel-heading"\x3eaction\x3c/div\x3e\n            \x3cdiv class\x3d"panel-body"\x3e\n                \x3cinput class\x3d"btn" type\x3d"file" accept\x3d".xml"\n                       ng:class\x3d"{\'btn-primary\': !fichier, \'btn-default\': fichier}" file-model\x3d"fichier" /\x3e\n\n                \x3cbutton class\x3d"pull-right btn"\n                        ng:class\x3d"{\'disabled btn-default\': !fichier, \'btn-primary\': fichier}"\n                        ng:click\x3d"process_load( fichier )" \x3e\n                    \x3cspan class\x3d"glyphicon glyphicon-log-in"\x3e\x3c/span\x3e Charger les donn\u00e9es et passer \u00e0 l\'\u00e9tape 2.\n                \x3c/button\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n    \x3c/uib-tab\x3e\n\n    \x3cuib-tab index\x3d"1" select\x3d"step \x3d 1; import_done \x3d false" disable\x3d"step \x3c 1"\x3e\n        \x3cuib-tab-heading\x3e\x3ch1\x3e2. Recoller les donn\u00e9es manquantes,\x3c/h1\x3e\x3c/uib-tab-heading\x3e\n\n        \x3cdiv class\x3d"panel panel-default col-md-3"\x3e\n            \x3cdiv class\x3d"panel-heading"\x3eexplications\x3c/div\x3e\n            \x3cdiv class\x3d"panel-body"\x3e\n                D\'abord il faut charger un fichier export\u00e9 depuis Pronote.\n            \x3c/div\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"panel panel-default col-md-9"\x3e\n            \x3cdiv class\x3d"panel-heading"\x3eaction\x3c/div\x3e\n            \x3cdiv class\x3d"panel-body"\x3e\n\n                \x3clabel\x3e\n                    \x3ccheckbox ng:model\x3d"scope.display_all"\x3e\x3c/checkbox\x3e\n                    Afficher tout.\n                \x3c/label\x3e\n\n                \x3cuib-tabset justified\x3d"true" active\x3d"0"\x3e\n                    \x3cuib-tab ng:repeat\x3d"dataset in matcheable_data"\x3e\n                        \x3cuib-tab-heading\x3e\n                            \x3ch4 ng:style\x3d"{\'color\': dataset.unmatched() \x3e 0 ? \'#eb5454\' : \'inherit\', \'font-weight\': dataset.unmatched() \x3e 0 ? \'bold\' : \'normal\'}"\x3e\n                                {{dataset.title}}\n                            \x3c/h4\x3e\n                            ({{dataset.unmatched()}} \u00e0 traiter sur {{dataset.total()}})\n                        \x3c/uib-tab-heading\x3e\n                        \x3cdiv class\x3d"panel"\x3e\n                            \x3ctable class\x3d"table table-striped table-bordered table-hover table-condensed" \x3e\n                                \x3cthead\x3e\n                                    \x3ctr\x3e\n                                        \x3cth\x3ePronote\x3c/th\x3e\n                                        \x3cth\x3eAnnuaire Acad\u00e9mique\x3c/th\x3e\n                                    \x3c/tr\x3e\n                                \x3c/thead\x3e\n                                \x3ctbody\x3e\n                                    \x3ctr ng:if\x3d"dataset.unmatched() \x3d\x3d 0 \x26\x26 !scope.display_all"\x3e\n                                        \x3ctd colspan\x3d3\x3e\n                                            \x3ch3\x3eAucun recoupement \u00e0 faire. \x3c/h3\x3e\n                                        \x3c/td\x3e\n                                    \x3c/tr\x3e\n\n                                    \x3c!-- matchablerow --\x3e\n                                    \x3ctr ng:repeat\x3d"node in dataset.pronote"\n                                        ng:if\x3d"node.edit || scope.display_all"\n                                        ng:class\x3d"{\'ok\': node.laclasse, \'ko\': !node.laclasse}"\x3e\n                                        \x3ctd\x3e\n                                            \x3cspan\x3e\n                                                {{node.displayed_label}}\n                                            \x3c/span\x3e\n                                        \x3c/td\x3e\n                                        \x3ctd\x3e\n                                            \x3cspan ng:if\x3d"!node.edit"\x3e{{node.laclasse.displayed_label}}\x3c/span\x3e\n                                            \x3cselect class\x3d"select-annuaire"\n                                                    ng:if\x3d"node.edit \x26\x26 matieres"\n                                                    ng:model\x3d"node.laclasse"\n                                                    ng:change\x3d"match_this( node, pronote.UAI )"\n                                                    ng:options\x3d"official as official.displayed_label for official in dataset.annuaire | orderBy:[\'displayed_label\']"\x3e{{official.displayed_label}}\x3c/select\x3e\n\n                                            \x3cdiv class\x3d"pull-right"\x3e\n                                                \x3cbutton class\x3d"btn btn-default"\n                                                        ng:if\x3d"node.edit \x26\x26 node.laclasse"\n                                                        ng:click\x3d"unmatch_this( node, pronote.UAI )"\x3e\x3cspan class\x3d"glyphicon glyphicon-erase" aria-hidden\x3d"true"\x3e\x3c/span\x3e\n                                                \x3c/button\x3e\n\n                                                \x3cbutton class\x3d"btn btn-default"\n                                                        ng:if\x3d"!node.edit"\n                                                        ng:click\x3d"node.edit \x3d true"\x3e\x3cspan class\x3d"glyphicon glyphicon-edit" aria-hidden\x3d"true"\x3e\x3c/span\x3e\n                                                \x3c/button\x3e\n                                            \x3c/div\x3e\n                                        \x3c/td\x3e\n                                    \x3c/tr\x3e\n                                    \x3c!-- /matchablerow --\x3e\n\n                                \x3c/tbody\x3e\n                            \x3c/table\x3e\n                        \x3c/div\x3e\n                    \x3c/uib-tab\x3e\n                \x3c/uib-tabset\x3e\n\n                \x3cbutton class\x3d"btn pull-right btn-success"\n                        ng:click\x3d"validate_matches()" \x3e\n                    Recollement possibles effectu\u00e9s, pass\u00e9 \u00e0 l\'\u00e9tape d\'import\n                \x3c/button\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n    \x3c/uib-tab\x3e\n\n    \x3cuib-tab index\x3d"2" select\x3d"step \x3d 2" disable\x3d"step \x3c 1"\x3e\n        \x3cuib-tab-heading\x3e\x3ch1\x3e3. Lancer l\'import.\x3c/h1\x3e \x3c/uib-tab-heading\x3e\n\n        \x3cdiv class\x3d"panel panel-default col-md-3"\x3e\n            \x3cdiv class\x3d"panel-heading"\x3eexplications\x3c/div\x3e\n            \x3cdiv class\x3d"panel-body"\x3e\n                D\'abord il faut charger un fichier export\u00e9 depuis Pronote.\n            \x3c/div\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"panel panel-default col-md-9"\x3e\n            \x3cdiv class\x3d"panel-heading"\x3eaction\x3c/div\x3e\n            \x3cdiv class\x3d"panel-body"\x3e\n                \x3cdiv class\x3d"panel panel-default import" style\x3d"color: #333;"\x3e\n                    \x3c!-- Crit\u00e8res de filtrage --\x3e\n                    \x3cfieldset class\x3d"col-md-12"\x3e\n                        \x3clegend\x3e \x3ch4\x3eS\u00e9lection des cr\u00e9neaux \u00e0 importer\x3c/h4\x3e  \x3c/legend\x3e\n\n                        \x3c!-- par regroupements --\x3e\n                        \x3cdiv class\x3d"col-md-4"\x3e\n                            \x3cdiv class\x3d"ui-select-wrapper"\x3e\n                                \x3cui-select multiple class\x3d"pull-left" theme\x3d"bootstrap"\n                                           append-to-body\x3d"true"\n                                           ng:model\x3d"scope.selected.classes"\x3e\n                                    \x3cui-select-match placeholder\x3d"Classe(s)..."\x3e\n                                        \x3cspan class\x3d"label label-success"\x3e{{$item.Nom}}\x3c/span\x3e \x3ci class\x3d"glyphicon glyphicon-warning-sign" style\x3d"color: red" title\x3d"Risque de duplication de cr\u00e9neaux d\u00e9j\u00e0 existants" ng:if\x3d"$item.existing_creneaux \x3e 0"\x3e\x3c/i\x3e\n                                    \x3c/ui-select-match\x3e\n                                    \x3cui-select-choices repeat\x3d"classe in pronote.Classes[0].Classe | orderBy:[\'Nom\']"\x3e\n                                        {{classe.Nom}}\x3ci class\x3d"glyphicon glyphicon-warning-sign" style\x3d"color: red" title\x3d"Risque de duplication de cr\u00e9neaux d\u00e9j\u00e0 existants" ng:if\x3d"classe.existing_creneaux \x3e 0"\x3e\x3c/i\x3e\n                                    \x3c/ui-select-choices\x3e\n                                \x3c/ui-select\x3e\n                                \x3cbutton class\x3d"btn btn-xs btn-primary"\n                                        ng:click\x3d"scope.selected.classes \x3d pronote.Classes[0].Classe"\x3e\x3cspan class\x3d"glyphicon glyphicon-certificate"\x3e\x3c/span\x3e\x3c/button\x3e\n                                \x3cbutton class\x3d"btn btn-xs btn-default"\n                                        ng:click\x3d"scope.selected.classes \x3d []"\x3e\x3cspan class\x3d"glyphicon glyphicon-erase"\x3e\x3c/span\x3e\x3c/button\x3e\n                            \x3c/div\x3e\n                        \x3c/div\x3e\n                        \x3cdiv class\x3d"col-md-4"\x3e\n                            \x3cdiv class\x3d"ui-select-wrapper"\x3e\n                                \x3cui-select multiple class\x3d"pull-left" theme\x3d"bootstrap"\n                                           append-to-body\x3d"true"\n                                           ng:model\x3d"scope.selected.groupes"\x3e\n                                    \x3cui-select-match placeholder\x3d"Groupe(s) d\'\u00e9l\u00e8ves..."\x3e\n                                        \x3cspan class\x3d"label label-info"\x3e{{$item.Nom}}\x3c/span\x3e \x3ci class\x3d"glyphicon glyphicon-warning-sign" style\x3d"color: red" title\x3d"Risque de duplication de cr\u00e9neaux d\u00e9j\u00e0 existants" ng:if\x3d"$item.existing_creneaux \x3e 0"\x3e\x3c/i\x3e\n                                    \x3c/ui-select-match\x3e\n                                    \x3cui-select-choices repeat\x3d"groupe in pronote.Groupes[0].Groupe | orderBy:[\'Nom\']"\x3e\n                                        {{groupe.Nom}}\x3ci class\x3d"glyphicon glyphicon-warning-sign" style\x3d"color: red" title\x3d"Risque de duplication de cr\u00e9neaux d\u00e9j\u00e0 existants" ng:if\x3d"groupe.existing_creneaux \x3e 0"\x3e\x3c/i\x3e\n                                    \x3c/ui-select-choices\x3e\n                                \x3c/ui-select\x3e\n                                \x3cbutton class\x3d"btn btn-xs btn-primary"\n                                        ng:click\x3d"scope.selected.groupes \x3d pronote.Groupes[0].Groupe"\x3e\x3cspan class\x3d"glyphicon glyphicon-certificate"\x3e\x3c/span\x3e\x3c/button\x3e\n                                \x3cbutton class\x3d"btn btn-xs btn-default"\n                                        ng:click\x3d"scope.selected.groupes \x3d []"\x3e\x3cspan class\x3d"glyphicon glyphicon-erase"\x3e\x3c/span\x3e\x3c/button\x3e\n                            \x3c/div\x3e\n                        \x3c/div\x3e\n\n                        \x3c!-- par mati\u00e8res --\x3e\n                        \x3cdiv class\x3d"col-md-4"\x3e\n                            \x3cdiv class\x3d"ui-select-wrapper"\x3e\n                                \x3cui-select multiple class\x3d"pull-left" theme\x3d"bootstrap"\n                                           append-to-body\x3d"true"\n                                           ng:model\x3d"scope.selected.matieres"\x3e\n                                    \x3cui-select-match placeholder\x3d"Mati\u00e8re(s)..."\x3e{{$item.Libelle}}\x3c/ui-select-match\x3e\n                                    \x3cui-select-choices repeat\x3d"matiere in pronote.Matieres[0].Matiere | orderBy:[\'Nom\']"\x3e\n                                        {{matiere.Libelle}}\n                                    \x3c/ui-select-choices\x3e\n                                \x3c/ui-select\x3e\n                                \x3cbutton class\x3d"btn btn-xs btn-primary"\n                                        ng:click\x3d"scope.selected.matieres \x3d pronote.Matieres[0].Matiere"\x3e\x3cspan class\x3d"glyphicon glyphicon-certificate"\x3e\x3c/span\x3e\x3c/button\x3e\n                                \x3cbutton class\x3d"btn btn-xs btn-default"\n                                        ng:click\x3d"scope.selected.matieres \x3d []"\x3e\x3cspan class\x3d"glyphicon glyphicon-erase"\x3e\x3c/span\x3e\x3c/button\x3e\n                            \x3c/div\x3e\n                        \x3c/div\x3e\n                    \x3c/fieldset\x3e\n                    \x3c!-- /Crit\u00e8res de filtrage --\x3e\n\n                    \x3cdiv class\x3d"col-md-12" style\x3d"text-align: right;"\x3e\n                        \x3cbutton class\x3d"btn btn-lg btn-warning"\n                                ng:click\x3d"process_import()"\x3e\n                            \x3cspan class\x3d"glyphicon glyphicon-cogs"\x3e\x3c/span\x3e Valider\n                        \x3c/button\x3e\n                    \x3c/div\x3e\n\n                    \x3cfieldset class\x3d"col-md-12 summary"\x3e\n                        \x3clabel\x3e\n                            Totalit\u00e9 des cr\u00e9neaux :\n                            \x3cul\x3e\n                                \x3cli\x3e{{counters.creneaux_ready}} cr\u00e9neaux valides\x3c/li\x3e\n                                \x3cli\x3e{{counters.creneaux_not_ready}} cr\u00e9neaux invalides (donn\u00e9es associ\u00e9es non recoll\u00e9es)\x3c/li\x3e\n                                \x3c!-- \x3cli\x3e{{counters.creneaux_broken}} cr\u00e9neaux non importables (donn\u00e9es manquantes)\x3c/li\x3e --\x3e\n                            \x3c/ul\x3e\n                        \x3c/label\x3e\n\n                        \x3clabel\x3e\n                            Cr\u00e9neaux s\u00e9lectionn\u00e9s :\n                            \x3cul\x3e\n                                \x3cli\x3e{{counters.filtered_creneaux_ready}} cr\u00e9neaux valides\x3c/li\x3e\n                                \x3cli\x3e{{counters.filtered_creneaux_not_ready}} cr\u00e9neaux invalides (donn\u00e9es associ\u00e9es non recoll\u00e9es)\x3c/li\x3e\n                            \x3c/ul\x3e\n                        \x3c/label\x3e\n                    \x3c/fieldset\x3e\n\n                    \x3cuib-accordion class\x3d"col-md-12"\x3e\n                        \x3cdiv uib-accordion-group is-open\x3d"ui.show_detailed_creneaux"\x3e\n                            \x3cuib-accordion-heading\x3e\n                                Afficher le d\u00e9tail des cr\u00e9neaux \x3ci class\x3d"glyphicon" ng:class\x3d"{\'glyphicon-chevron-down\': ui.show_detailed_creneaux, \'glyphicon-chevron-right\': !ui.show_detailed_creneaux}"\x3e\x3c/i\x3e\n                            \x3c/uib-accordion-heading\x3e\n                            \x3cdiv class\x3d"col-md-12"\n                                 ng:if\x3d"ui.show_detailed_creneaux"\x3e\n                                \x3cdiv class\x3d"btn-group pull-right" role\x3d"group" style\x3d"margin:0 6px 6px 0;"\x3e\n                                    \x3cbutton class\x3d"btn"\n                                            ng:class\x3d"{\' btn-primary active\': ui.display_ready, \'btn-default\': !ui.display_ready}"\n                                            ng:click\x3d"ui.display_ready \x3d !ui.display_ready"\x3e\n                                        \x3ci class\x3d"glyphicon" ng:class\x3d"{\'glyphicon-eye-open\': ui.display_ready, \'glyphicon-eye-close\': !ui.display_ready}"\x3e\x3c/i\x3e Cr\u00e9neaux valides.\n                                    \x3c/button\x3e\n                                    \x3cbutton class\x3d"btn btn-default"\n                                            ng:class\x3d"{\' btn-primary active\': ui.display_problems, \'btn-default\': !ui.display_problems}"\n                                            ng:click\x3d"ui.display_problems \x3d !ui.display_problems"\x3e\n                                        \x3ci class\x3d"glyphicon" ng:class\x3d"{\'glyphicon-eye-open\': ui.display_problems, \'glyphicon-eye-close\': !ui.display_problems}"\x3e\x3c/i\x3e Cr\u00e9neaux \u00e0 traiter.\n                                    \x3c/button\x3e\n                                \x3c/div\x3e\n                            \x3c/div\x3e\n\n                            \x3ctable class\x3d"table table-striped table-bordered table-hover table-condensed"\n                                   ng:class\x3d"{\'hidden\': !ui.show_detailed_creneaux}"\n                                   ng:if\x3d"ui.show_detailed_creneaux"\x3e\n                                \x3cthead\x3e\n                                    \x3ctr\x3e\n                                        \x3cth\x3e\x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'Jour\'] )"\x3eJour\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'Jour\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-Jour\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'NumeroPlaceDebut\'] )"\x3e\u00e0\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'NumeroPlaceDebut\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-NumeroPlaceDebut\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'NombrePlaces\'] )"\x3ependant\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'NombrePlaces\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-NombrePlaces\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'Matiere\'] )"\x3emati\u00e8re\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'Matiere\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-Matiere\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'Professeur\'] )"\x3eenseignant(s)\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'Professeur\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-Professeur\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'Classe\',\'Groupe\'] )"\x3eregroupement(s)\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'Classe\',\'Groupe\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-Classe\',\'-Groupe\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'Salle\'] )"\x3esalle(s)\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'Salle\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-Salle\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                        \x3cth\x3e\n                                            \x3ca ng:click\x3d"ui.sort_creneaux_by( [\'ready\'] )"\x3e\x3ci class\x3d"glyphicon glyphicon-warning-sign" title\x3d"Probl\u00e8me(s) identifi\u00e9(s)"\x3e\x3c/i\x3e\x3c/a\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'ready\']"\x3e\u2191\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"ui.sortCreneauxBy \x3d\x3d [\'-ready\']"\x3e\u2193\x3c/span\x3e\n                                        \x3c/th\x3e\n                                    \x3c/tr\x3e\n                                \x3c/thead\x3e\n                                \x3ctbody\x3e\n                                    \x3c!--  | filter:filter_creneau( ui, scope.selected ) | orderBy:ui.sortCreneauxBy --\x3e\n                                    \x3ctr ng:repeat\x3d"creneau in scope.creneaux | filter:filter_creneau( ui, scope.selected ) | orderBy:ui.sortCreneauxBy"\n                                        ng:class\x3d"{\'ok\': creneau.ready, \'ko\': !creneau.ready}"\x3e\n                                        \x3ctd\x3e\n                                            {{$index + 1}}\n                                        \x3c/td\x3e\n                                        \x3ctd\x3e\n                                            {{jours_de_la_semaine[ creneau.Jour ]}}\n                                        \x3c/td\x3e\n                                        \x3ctd\x3e\n                                            {{pronote.plages_horaires[ creneau.NumeroPlaceDebut ].LibelleHeureDebut}}\n                                        \x3c/td\x3e\n                                        \x3ctd\x3e\n                                            {{creneau.NombrePlaces * pronote.GrilleHoraire[0].DureePlace}} minutes\n                                        \x3c/td\x3e\n                                        \x3ctd ng:class\x3d"{\'ko rouge\': !creneau.readiness.matiere }"\x3e\n                                            \x3cspan ng:if\x3d"creneau.Matiere"\x3e{{pronote.matieres[ creneau.Matiere.Ident ].displayed_label}}\x3c/span\x3e\n                                        \x3c/td\x3e\n                                        \x3ctd ng:class\x3d"{\'ko rouge\': !creneau.readiness.enseignant }"\x3e\n                                            \x3cspan ng:if\x3d"creneau.Professeur"\x3e{{pronote.enseignants[ creneau.Professeur.Ident ].displayed_label}} \x3csup uib-tooltip-html\x3d"beautify_semainier( creneau.Professeur.Semaines )" tooltip-trigger\x3d"\'click\'"\x3e({{creneau.Professeur.Semaines}})\x3c/sup\x3e\x3c/span\x3e\n                                        \x3c/td\x3e\n                                        \x3ctd ng:class\x3d"{\'ko rouge\': !creneau.readiness.classe \x26\x26 !creneau.readiness.groupe_eleve }"\x3e\n                                            \x3cspan ng:if\x3d"creneau.Classe"\x3e{{pronote.classes[ creneau.Classe.Ident ].Nom}} \x3csup uib-tooltip-html\x3d"beautify_semainier( creneau.Classe.Semaines )" tooltip-trigger\x3d"\'click\'"\x3e({{creneau.Classe.Semaines}})\x3c/sup\x3e\x3c/span\x3e\n                                            \x3cspan ng:if\x3d"creneau.Groupe"\x3e{{pronote.groupes_eleves[ creneau.Groupe.Ident ].Nom}} \x3csup uib-tooltip-html\x3d"beautify_semainier( creneau.Groupe.Semaines )" tooltip-trigger\x3d"\'click\'"\x3e({{creneau.Groupe.Semaines}})\x3c/sup\x3e\x3c/span\x3e\n                                        \x3c/td\x3e\n                                        \x3ctd\x3e\n                                            \x3cspan ng:if\x3d"creneau.Salle"\x3e{{pronote.salles[ creneau.Salle.Ident ].Nom}} \x3csup uib-tooltip-html\x3d"beautify_semainier( creneau.Salle.Semaines )" tooltip-trigger\x3d"\'click\'"\x3e({{creneau.Salle.Semaines}})\x3c/sup\x3e\x3c/span\x3e\n                                        \x3c/td\x3e\n                                        \x3ctd class\x3d"import-readiness"\n                                            ng:class\x3d"{\'vert\': creneau.ready, \'rouge\': !creneau.ready }"\x3e\n                                            \x3cspan ng:if\x3d"creneau.ready"\x3e \x3ci class\x3d"glyphicon glyphicon-ok" title\x3d"Aucun probl\u00e8me"\x3e\x3c/i\x3e \x3c/span\x3e\n\n                                            \x3cspan ng:if\x3d"!creneau.readiness.matiere"\x3e \x3ci class\x3d"glyphicon glyphicon-book" title\x3d"Mati\u00e8re inconnue"\x3e\x3c/i\x3e \x3c/span\x3e\n                                            \x3cspan ng:if\x3d"!creneau.readiness.enseignant"\x3e \x3ci class\x3d"glyphicon glyphicon-user" title\x3d"Enseignant inconnu"\x3e\x3c/i\x3e \x3c/span\x3e\n                                            \x3cspan ng:if\x3d"!creneau.readiness.classe \x26\x26 !creneau.readiness.groupe_eleve"\x3e \x3ci class\x3d"glyphicon glyphicon-education" title\x3d"Classe/Groupe inconnu"\x3e\x3c/i\x3e \x3c/span\x3e\n                                        \x3c/td\x3e\n                                    \x3c/tr\x3e\n                                \x3c/tbody\x3e\n                            \x3c/table\x3e\n                        \x3c/div\x3e\n                    \x3c/uib-accordion\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n            \x3c/div\x3e\n    \x3c/uib-tab\x3e\n\x3c/uib-tabset\x3e\n')}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/index.html",'\x3cheader ng:controller\x3d"HeaderCtrl"\n        ng:class\x3d"{\'embedded\': embedded}"\x3e\n\n    \x3cdiv class\x3d"onglets"\x3e\n        \x3ca class\x3d"btn"\n           ng:repeat\x3d"tab in tabs"\n           ui:sref\x3d"{{tab.uisref}}"\n           ng:class\x3d"{\'btn-warning\': tab.active, \'btn-default\': !tab.active}"\n           ng:click\x3d"set_active_tab( tab.uisref )"\x3e\n            \x3cspan class\x3d"{{tab.css_class}}"\x3e\x3c/span\x3e {{tab.heading}}\n        \x3c/a\x3e\n\n        \x3cselect class\x3d"pull-right choix-enfant"\n                ng:if\x3d"current_user \x26\x26 current_user.profil_actif.type \x3d\x3d\x3d \'TUT\'"\n                ng:options\x3d"enfant as enfant.enfant.firstname+\' \'+enfant.enfant.lastname for enfant in current_user.enfants track by enfant.enfant.id"\n                ng:model\x3d"current_user.enfant_actif"\n                ng:change\x3d"reload()"\x3e\x3c/select\x3e\n    \x3c/div\x3e\n\x3c/header\x3e\n\n\n\x3cdiv id\x3d"ui-view-content"\n     ui-view\x3d"content"\n     ng:class\x3d"{\'embedded\': embedded}"\x3e\x3c/div\x3e\n\n\x3cfooter class\x3d"col-md-12"\n        ng:controller\x3d"FooterCtrl" ng:cloak\x3e\n    \x3cdiv class\x3d"pull-left"\x3e\n        \x3cdiv class\x3d"btn-group" uib-dropdown\x3e\n            \x3cbutton uib-dropdown-toggle type\x3d"button" class\x3d"btn btn-xs btn-default uib-dropdown-toggle"\x3e\n                \x3cspan class\x3d"glyphicon glyphicon-cog"\x3e\x3c/span\x3e Pr\u00e9f\u00e9rences\n            \x3c/button\x3e\n            \x3cul uib-dropdown-menu class\x3d"uib-dropdown-menu user-preferences" role\x3d"menu"\x3e\n                \x3cli\x3e\x3clabel\x3e\x3ccheckbox ng:model\x3d"current_user.parametrage_cahier_de_textes.affichage_week_ends"\n                                     ng:change\x3d"save_and_reload()"\x3e\x3c/checkbox\x3e Afficher les week-ends\x3c/label\x3e\x3c/li\x3e\n                \x3cli class\x3d"divider"\x3e\x3c/li\x3e\n                \x3cli\x3e\x3clabel\x3e\x3ccheckbox ng:model\x3d"current_user.parametrage_cahier_de_textes.affichage_types_de_devoir"\n                                     ng:change\x3d"save_and_reload()"\x3e\x3c/checkbox\x3e Afficher les types de devoirs\x3c/label\x3e\x3c/li\n            \x3c/ul\x3e\n        \x3c/div\x3e\n    \x3c/div\x3e\n    \x3ca href\x3d"https://github.com/laclasse-com/service-cahiertextes" class\x3d"pull-right"\x3eversion {{version}}\x3c/a\x3e\n\x3c/footer\x3e\n')}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/popup_display.html",'\x3cdiv class\x3d"modal-header"\x3e\n    \x3ch3\x3e{{date | date : \'fullDate\' }}\x3cspan ng:if\x3d"creneau.salles.length \x3e 0"\x3e, salle {{creneau.salles[0].nom}}\x3c/span\x3e\x3c/h3\x3e\n    \x3ch4\x3e{{matiere.name}}\x3c/h4\x3e\n\x3c/div\x3e\n\n\x3cdiv class\x3d"modal-body"\x3e\n\n    \x3cuib-tabset\x3e\n\n        \x3cuib-tab ng:if\x3d"devoirs.length \x3e 0" heading\x3d"Travail \u00e0 faire"\x3e\n            \x3cdiv ng:repeat\x3d"devoir in devoirs"\n                 class\x3d"devoir col-md-12" \x3e\n                \x3cdiv class\x3d"col-md-8"\x3e\n                    \x3cdisplay-devoir devoir\x3d"devoir"\x3e\x3c/display-devoir\x3e\n                \x3c/div\x3e\n                \x3cdiv class\x3d"col-md-4"\x3e\n                    \x3cul\x3e\n                        \x3cli class\x3d"clickable"\n                            tooltip-trigger\x3d"\'click\'"\n                            tooltip-placement\x3d"right"\n                            uib-tooltip-html\x3d"devoir.cours.contenu"\x3e\n                            \x3cspan\x3e\x3ci class\x3d"picto" ng:style\x3d"{\'background-image\':\'url(\' + app_path + \'/app/node_modules/laclasse-common-client/images/picto_cours.svg)\'}"\x3e\x3c/i\x3e S\u00e9quence p\u00e9dagogique : \x3cem\x3e{{devoir.cours.date_cours | date : \'dd/MM\'}}\x3c/em\x3e\x3c/span\x3e\n                        \x3c/li\x3e\n                    \x3c/ul\x3e\n                    \x3cswitch-devoir devoir\x3d"devoir"\n                                   ng:if\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'ELV\'" \x3e\x3c/switch-devoir\x3e\n\n                \x3c/div\x3e\n            \x3c/div\x3e\n            \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n        \x3c/uib-tab\x3e\n\n        \x3cuib-tab heading\x3d"S\u00e9quence p\u00e9dagogique"\x3e\n            \x3cdiv class\x3d"col-md-8"\x3e\n                \x3cdisplay-sequence-pedagogique sp\x3d"cours" ng:if\x3d"cours.contenu" \x3e\x3c/display-sequence-pedagogique\x3e\n            \x3c/div\x3e\n\n            \x3cdiv class\x3d"col-md-4"\x3e\n                \x3cul\x3e\n                    \x3cli class\x3d"clickable" ng:repeat\x3d"devoir in cours.devoirs"\n                        tooltip-trigger\x3d"\'click\'"\n                        tooltip-placement\x3d"right"\n                        uib-tooltip-html\x3d"devoir.tooltip"\n                        ng:class\x3d"{ \'type1\': devoir.type_devoir_id \x3d\x3d 1, \'type2\': devoir.type_devoir_id \x3d\x3d 2, \'type3\': devoir.type_devoir_id \x3d\x3d 3, \'type4\': devoir.type_devoir_id \x3d\x3d 4, \'type5\': devoir.type_devoir_id \x3d\x3d 5, \'type6\': devoir.type_devoir_id \x3d\x3d 6, \'fait\': devoir.fait }" \x3e\n                        \x3cspan\x3e\x3ci class\x3d"picto" ng:style\x3d"{\'background-image\':\'url(\' + app_path + \'/app/node_modules/laclasse-common-client/images/picto_devoir.svg)\'}"\x3e\x3c/i\x3e Devoir associ\u00e9 : \x3cem\x3e{{devoir.date_due | date : \'dd/MM\'}}\x3c/em\x3e\x3c/span\x3e\n                    \x3c/li\x3e\n                \x3c/ul\x3e\n            \x3c/div\x3e\n\n            \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n        \x3c/uib-tab\x3e\n    \x3c/uib-tabset\x3e\n\x3c/div\x3e\n\n\x3cdiv class\x3d"modal-footer"\x3e\n    \x3cbutton class\x3d"btn btn-default btn-sm pull-right" ng:click\x3d"fermer()"\x3e\n        \x3cspan class\x3d"glyphicon glyphicon-remove-sign"\x3e\x3c/span\x3e Fermer\n    \x3c/button\x3e\n\x3c/div\x3e\n')}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/popup_edition.html",'\x3cdiv class\x3d"modal-header"\n     ng:class\x3d"{\'not-yours\': !creneau.mine}"\x3e\n\n    \x3c!-- {{{ Lecture seule --\x3e\n    \x3cspan ng:if\x3d"!mode_edition_creneau"\x3e\n        \x3ch3\x3e{{creneau.heure_debut | amDateFormat : \'dddd D MMMM YYYY\' }}, semaine {{creneau.n_week}}\x3c/h3\x3e\n        \x3ch4\x3e\n            {{selected_regroupement.name}} - {{selected_matiere.name}} ({{creneau.heure_debut | amDateFormat: \'HH:mm\'}} - {{creneau.heure_fin | amDateFormat: \'HH:mm\'}}\x3cspan ng:if\x3d"creneau.salles.length \x3e 0"\x3e, salle {{creneau.salles[0].nom}}\x3c/span\x3e)\n        \x3c/h4\x3e\n    \x3c/span\x3e\n    \x3c!-- }}} --\x3e\n\n    \x3c!-- {{{ \u00c9dition --\x3e\n    \x3cdiv class\x3d"edition-creneau"\n         ng:if\x3d"mode_edition_creneau"\x3e\n        \x3cdiv class\x3d"col-md-6"\x3e\n            \x3clabel\x3eChoisir la classe/le groupe :\x3c/label\x3e\n            \x3cselect ng:model\x3d"scope.selected_regroupement"\n                    ng:options\x3d"classe as classe.name group by classe.type for classe in classes | orderBy:[\'type\',\'name\']"\n                    ng:required\x3d"true"\x3e\n            \x3c/select\x3e\n        \x3c/div\x3e\n\n        \x3cdiv class\x3d"col-md-6"\x3e\n            \x3clabel\x3eChoisir la mati\u00e8re :\x3c/label\x3e\n            \x3cselect ng:model\x3d"scope.selected_matiere"\n                    ng:options\x3d"matiere as matiere.name for matiere in matieres | orderBy:[\'name\']"\n                    ng:required\x3d"true"\x3e\n            \x3c/select\x3e\n        \x3c/div\x3e\n\n        \x3cdiv class\x3d"col-md-12 horaire"\x3e\n            \x3clabel\x3eChoisir l\'horaire :\x3c/label\x3e\n            \x3cselect ng:options\x3d"index as jour for (index, jour) in jours"\n                    ng:model\x3d"creneau.jour_de_la_semaine"\x3e\n            \x3c/select\x3e\n            de\n            \x3cdiv uib-dropdown class\x3d"uib-dropdown horaire"\x3e\n                \x3ca uib-dropdown-toggle class\x3d"uib-dropdown-toggle" role\x3d"button" data-toggle\x3d"uib-dropdown" data-target\x3d"#" href\x3d""\x3e{{creneau.tmp_heure_debut | amDateFormat: \'HH:mm\'}}\x3c/a\x3e\n                \x3cdiv uib-dropdown-menu class\x3d"uib-dropdown-menu" role\x3d"menu" ng:click\x3d"$event.stopPropagation()"\x3e\n                    \x3cdiv uib-timepicker\n                         class\x3d"uib-timepicker"\n                         ng:model\x3d"creneau.tmp_heure_debut"\n                         data-show-meridian\x3d"false"\n                         data-minute-step\x3d"5"\n                         ng:required\x3d"true"\x3e\x3c/div\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n            \u00e0\n            \x3cdiv uib-dropdown class\x3d"uib-dropdown horaire"\x3e\n                \x3ca uib-dropdown-toggle class\x3d"uib-dropdown-toggle" role\x3d"button" data-toggle\x3d"uib-dropdown" data-target\x3d"#" href\x3d""\x3e{{creneau.tmp_heure_fin | amDateFormat: \'HH:mm\'}}\x3c/a\x3e\n                \x3cdiv uib-dropdown-menu class\x3d"uib-dropdown-menu" role\x3d"menu" ng:click\x3d"$event.stopPropagation()"\x3e\n                    \x3cdiv uib-timepicker\n                         class\x3d"uib-timepicker"\n                         ng:model\x3d"creneau.tmp_heure_fin"\n                         data-show-meridian\x3d"false"\n                         data-minute-step\x3d"5"\n                         ng:required\x3d"true"\x3e\x3c/div\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"col-md-12"\x3e\n            \x3clabel\x3eChoisir les semaines actives :\x3c/label\x3e\n            \x3cdiv class\x3d"btn-group templates-semainier"\x3e\n                \x3cbutton class\x3d"btn btn-xs"\n                        ng:repeat\x3d"template in templates_semainier"\n                        ng:click\x3d"template.apply()"\x3e{{template.label}}\x3c/button\x3e\n            \x3c/div\x3e\n            \x3cdiv class\x3d"semainier"\x3e\n                \x3cfieldset ng:repeat\x3d"mois in overlay_semainier | orderBy:\'index\'"\x3e\n                    \x3clegend\x3e{{mois.label}}\x3c/legend\x3e\n                    \x3cdiv class\x3d"btn-group"\x3e\n                        \x3cbutton type\x3d"button" class\x3d"btn btn-xs btn-default"\n                                ng:repeat\x3d"semaine in mois.semaines track by $index"\n                                ng:class\x3d"{\'active\': semaines_actives.regroupement[ semaine.semaine - 1 ], \'vacances\': sont_ce_les_vacances( semaine.semaine, ZONE ), \'this-week\': semaine.semaine \x3d\x3d\x3d creneau.n_week}"\n                                ng:model\x3d"semaines_actives.regroupement[ semaine.semaine - 1 ]"\n                                uib-btn-checkbox\n                                btn-checkbox-true\x3d"1"\n                                btn-checkbox-false\x3d"0" \x3e\n                            {{semaine.semaine}}\n                        \x3c/button\x3e\n                    \x3c/div\x3e\n                \x3c/fieldset\x3e\n            \x3c/div\x3e\n\n            \x3cdiv class\x3d"pull-right legende"\x3e\n                \x3clabel\x3eL\u00e9gende :\x3c/label\x3e\n                \x3cspan class\x3d"btn btn-xs btn-default" title\x3d"Cr\u00e9neau absent de cette semaine"\x3e \x3c/span\x3e Cr\u00e9neau absent de cette semaine\n                \x3cspan class\x3d"btn btn-xs btn-default active" title\x3d"Cr\u00e9neau pr\u00e9sent cette semaine"\x3e \x3c/span\x3e Cr\u00e9neau pr\u00e9sent cette semaine\n                \x3cspan class\x3d"btn btn-xs btn-default vacances" title\x3d"Vacances scolaires"\x3e \x3c/span\x3e Vacances scolaires\n            \x3c/div\x3e\n\n        \x3c/div\x3e\n    \x3c/div\x3e\n    \x3c!-- }}} --\x3e\n\n    \x3cdiv class\x3d"error-messages"\x3e\n        \x3cdiv class\x3d"alert alert-danger" role\x3d"alert" ng:repeat\x3d"erreur in erreurs"\x3e{{erreur.message}}\x3c/div\x3e\n    \x3c/div\x3e\n\x3c/div\x3e\n\n\x3cdiv class\x3d"modal-body" ng:if\x3d"!mode_edition_creneau \x26\x26 !mode_duplication"\x3e\n    \x3cuib-tabset\x3e\n\n        \x3c!-- ####################### S\u00e9quence P\u00e9dagogique du jour ####################### --\x3e\n        \x3cuib-tab heading\x3d"S\u00e9quence p\u00e9dagogique du jour" \x3e\n            \x3cdiv class\x3d"row"\x3e\n                \x3cdiv class\x3d"col-md-9 contenu"\x3e\n                    \x3cdiv class\x3d"panel panel-default"\x3e\n\n                        \x3cdiv data-text-angular\n                             class\x3d"panel-body"\n                             ng:model\x3d"cours.contenu"\n                             ng:change\x3d"is_dirty( cours )"\n                             ng:if\x3d"cours.editable \x26\x26 !cours.deleted" \x3e\x3c/div\x3e\n                        \x3cdiv class\x3d"panel-body"\n                             ng:bind-html\x3d"cours.contenu"\n                             ng:if\x3d"!cours.editable \x26\x26 !cours.deleted" \x3e\x3c/div\x3e\n                        \x3cdiv class\x3d"panel-body deleted"\n                             ng:if\x3d"cours.deleted" \x3e(S\u00e9quence p\u00e9dagogique supprim\u00e9e)\x3c/div\x3e\n                        \x3cdiv class\x3d"panel-footer ressources" ng:if\x3d"!cours.deleted"\x3e\n                            \x3cdiv class\x3d"row"\x3e\n                                \x3cdiv class\x3d"attached-document" ng:repeat\x3d"ressource in cours.ressources"\x3e\n                                    \x3ca target\x3d"_blank" href\x3d"{{ressource.url}}"\x3e{{ressource.name}}\x3c/a\x3e\n                                    \x3cbutton class\x3d"btn btn-sm btn-danger" ng:click\x3d"remove_ressource( cours, ressource.hash )"\x3e\u2715\x3c/button\x3e\n                                \x3c/div\x3e\n                            \x3c/div\x3e\n\n                            \x3cdiv uib-dropdown class\x3d"uib-dropdown" ng:if\x3d"!creneau.etranger"\x3e\n                                \x3cbutton uib-dropdown-toggle class\x3d"btn btn-sm btn-default uib-dropdown-toggle pull-right" role\x3d"button" data-toggle\x3d"uib-dropdown" data-target\x3d"#" href\x3d""\n                                        ng:class\x3d"{\'disabled\': faulty_docs_app}"\x3e\n                                    \x3cspan class\x3d"glyphicon glyphicon-plus-sign"\x3e\x3c/span\x3e Ajouter une ressource\n                                \x3c/button\x3e\n                                \x3cdiv uib-dropdown-menu class\x3d"uib-dropdown-menu" role\x3d"menu" ng:click\x3d"$event.stopPropagation()"\x3e\n                                    \x3cdiv cartable\n                                         class\x3d"treecontrol-container"\n                                         racine\x3d"cartable.files"\n                                         target\x3d"cours"\n                                         regroupement\x3d"selected_regroupement"\n                                         add-callback\x3d"consume_Documents_response_callback"\x3e\n                                    \x3c/div\x3e\n                                    \x3cinput type\x3d"file"\n                                           class\x3d"upload"\n                                           name\x3d"upload[]"\n                                           onchange\x3d"angular.element(this).scope().upload_and_add_ressource( angular.element(this).scope().cours, this.files)" /\x3e\n                                \x3c/div\x3e\n                            \x3c/div\x3e\n                            \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n                        \x3c/div\x3e\n                    \x3c/div\x3e\n                \x3c/div\x3e\n                \x3cdiv class\x3d"col-md-3 infos"\x3e\n                    \x3cul class\x3d"pull-left"\x3e\n                        \x3cli class\x3d"clickable"\n                            ng:repeat\x3d"devoir in cours.devoirs"\n                            ng:if\x3d"!devoir.deleted"\n                            uib-tooltip-html\x3d"devoir.tooltip"\n                            tooltip-trigger\x3d"\'click\'"\n                            tooltip-placement\x3d"bottom"\n                            ng:class\x3d"{ \'type1\': devoir.type_devoir_id \x3d\x3d 1, \'type2\': devoir.type_devoir_id \x3d\x3d 2, \'type3\': devoir.type_devoir_id \x3d\x3d 3, \'type4\': devoir.type_devoir_id \x3d\x3d 4, \'type5\': devoir.type_devoir_id \x3d\x3d 5, \'type6\': devoir.type_devoir_id \x3e\x3d 6, \'fait\': devoir.fait }" \x3e\n                            \x3cspan\x3e\x3ci class\x3d"picto" ng:style\x3d"{\'background-image\':\'url(\' + app_path + \'/app/vendor/laclasse-common-client/images/picto_devoir.svg)\'}"\x3e\x3c/i\x3e Devoir associ\u00e9 : \x3cem\x3e{{devoir.date_due | date : \'dd/MM\'}}\x3c/em\x3e\x3c/span\x3e\n                        \x3c/li\x3e\n                    \x3c/ul\x3e\n                \x3c/div\x3e\n                \x3cdiv class\x3d"col-md-3" ng:if\x3d"cours.id"\x3e\n                    \x3cbutton type\x3d"button" class\x3d"btn btn-xs btn-danger pull-right supprimer"\n                            ng:click\x3d"effacer_cours(  )"\n                            ng:if\x3d"cours.id \x26\x26 ( cours.deleted || ( !creneau.etranger \x26\x26 cours.editable ) )" \x3e\n                        \x3cspan ng:if\x3d"!cours.deleted"\x3e\x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e Supprimer\x3c/span\x3e\n                        \x3cspan ng:if\x3d"cours.deleted"\x3e\x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e Annuler la suppression\x3c/span\x3e\n                    \x3c/button\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n\n            \x3cdiv class\x3d"panel panel-default"\x3e\n                \x3cdiv class\x3d"panel-heading"\x3e\n                    Travail \u00e0 faire suite \u00e0 cette s\u00e9quence p\u00e9dagogique\n                \x3c/div\x3e\n                \x3cdiv class\x3d"panel-body"\x3e\n                    \x3cbutton class\x3d"btn btn-default ajout-devoir"\n                            ng:if\x3d"creneau.can_add_homework"\n                            ng:click\x3d"ajout_devoir( cours.devoirs, \'next\' )"\x3e\n                        \x3cspan class\x3d"glyphicon glyphicon-plus-sign"\x3e\x3c/span\x3e Ajouter un devoir\n                    \x3c/button\x3e\n                    \x3cdiv class\x3d"panel panel-default"\n                         ng:repeat\x3d"devoir in cours.devoirs"\x3e\n\n                        \x3cdiv class\x3d"row"\x3e\n                            \x3cdiv class\x3d"col-md-9"\n                                 ng:if\x3d"!devoir.deleted"\x3e\n                                \x3cdiv class\x3d"panel-heading enseignant-saisie" ng:if\x3d"!creneau.etranger"\x3e\n                                    \x3clabel class\x3d"col-md-6" ng:if\x3d"current_user.parametrage_cahier_de_textes.affichage_types_de_devoir"\x3eType de travail :\n                                        \x3cselect ng:required\x3d"true"\n                                                ng:change\x3d"is_dirty( devoir )"\n                                                ng:model\x3d"devoir.type_devoir_id"\n                                                ng:options\x3d"type_de_devoir.id as type_de_devoir.description for type_de_devoir in types_de_devoir"\x3e\n                                        \x3c/select\x3e\n                                    \x3c/label\x3e\n                                    \x3clabel class\x3d"col-md-6"\x3eDate de rendu :\n                                        \x3cselect ng:required\x3d"true"\n                                                ng:model\x3d"devoir.date_due"\n                                                ng:change\x3d"set_creneau_date_due( devoir )"\n                                                ng:options\x3d"creneau.date_due as formateCreneau( creneau ) group by creneau.semaine for creneau in creneaux_devoirs_possibles"\x3e\n                                        \x3c/select\x3e\n                                    \x3c/label\x3e\n\n                                    \x3cdiv class\x3d"col-md-12"\x3e\n                                        \x3clabel\x3eTemps de travail estim\u00e9 : \x3c/label\x3e\n                                        \x3cspan uib-rating\n                                              ng:model\x3d"devoir.temps_estime"\n                                              max\x3d"15"\n                                              readonly\x3d"false"\n                                              ng:click\x3d"is_dirty( devoir )"\n                                              on-hover\x3d"estimation_over(devoir, value)"\n                                              on-leave\x3d"estimation_leave(devoir)"\n                                              state-on\x3d"\'temps-est-on\'"\n                                              state-off\x3d"\'temps-est-off\'"\x3e\x3c/span\x3e\n                                        \x3cspan class\x3d"label pull-right" ng:class\x3d"{\'label-success\': devoir.overValue\x3c4, \'label-info\': devoir.overValue\x3e\x3d4 \x26\x26 devoir.overValue\x3c8 , \'label-warning\': devoir.overValue\x3e\x3d8 \x26\x26 devoir.overValue\x3c12, \'label-danger\': devoir.overValue\x3e\x3d12}" ng:if\x3d"devoir.overValue \x3e 0 || devoir.temps_estime \x3e 0"\x3e{{devoir.minutes || devoir.temps_estime * 5}} min\x3c/span\x3e\n                                    \x3c/div\x3e\n                                    \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n                                \x3c/div\x3e\n                                \x3ctext-angular class\x3d"panel-body" ng:model\x3d"devoir.contenu" ng:change\x3d"is_dirty( devoir )" ng:if\x3d"!creneau.etranger"\x3e\x3c/text-angular\x3e\n\n                                \x3cdiv class\x3d"panel-heading enseignant-saisie" ng:if\x3d"creneau.etranger"\x3e\n                                    \x3clabel ng:if\x3d"current_user.parametrage_cahier_de_textes.affichage_types_de_devoir"\x3eType de travail : \x3cem\x3e{{devoir.type_devoir.description}}\x3c/em\x3e\x3c/label\x3e\n                                    \x3clabel ng:if\x3d"devoir.temps_estime"\x3eTemps de travail estim\u00e9 : \x3cem\x3e{{devoir.temps_estime * 5}} min\x3c/em\x3e\x3c/label\x3e\n                                \x3c/div\x3e\n                                \x3cdiv class\x3d"panel-body" ng:bind-html\x3d"devoir.contenu" ng:if\x3d"creneau.etranger"\x3e\x3c/div\x3e\n\n                                \x3cdiv class\x3d"panel-footer ressources"\x3e\n                                    \x3cdiv class\x3d"row"\x3e\n                                        \x3cdiv class\x3d"attached-document" ng:repeat\x3d"ressource in devoir.ressources"\x3e\n                                            \x3ca target\x3d"_blank" href\x3d"{{ressource.url}}"\x3e{{ressource.name}}\x3c/a\x3e\n                                            \x3cbutton class\x3d"btn btn-sm btn-danger" ng:click\x3d"remove_ressource( devoir, ressource.hash )"\x3e\u2715\x3c/button\x3e\n                                        \x3c/div\x3e\n                                    \x3c/div\x3e\n\n                                    \x3cdiv uib-dropdown class\x3d"uib-dropdown" ng:if\x3d"!creneau.etranger"\x3e\n                                        \x3cbutton uib-dropdown-toggle class\x3d"btn btn-sm btn-default uib-dropdown-toggle pull-right" role\x3d"button" data-toggle\x3d"uib-dropdown" data-target\x3d"#" href\x3d""\n                                                ng:class\x3d"{\'disabled\': faulty_docs_app}"\x3e\n                                            \x3cspan class\x3d"glyphicon glyphicon-plus-sign"\x3e\x3c/span\x3e Ajouter une ressource\n                                        \x3c/button\x3e\n                                        \x3cdiv uib-dropdown-menu class\x3d"uib-dropdown-menu" role\x3d"menu" ng:click\x3d"$event.stopPropagation()"\x3e\n                                            \x3cdiv cartable\n                                                 class\x3d"treecontrol-container"\n                                                 racine\x3d"cartable.files"\n                                                 target\x3d"devoir"\n                                                 regroupement\x3d"selected_regroupement"\n                                                 add-callback\x3d"consume_Documents_response_callback"\x3e\n                                            \x3c/div\x3e\n\n                                            \x3cinput type\x3d"file"\n                                                   class\x3d"upload"\n                                                   name\x3d"upload[]"\n                                                   onchange\x3d"angular.element(this).scope().upload_and_add_ressource( angular.element(this).scope().devoir, this.files)" /\x3e\n                                        \x3c/div\x3e\n                                    \x3c/div\x3e\n                                    \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n                                \x3c/div\x3e\n\n                            \x3c/div\x3e\n\n                            \x3cdiv class\x3d"col-md-9 deleted"\n                                 ng:if\x3d"devoir.deleted" \x3e(Devoir supprim\u00e9)\x3c/div\x3e\n\n                            \x3cdiv class\x3d"col-md-3"\x3e\n                                \x3cbutton type\x3d"button" class\x3d"btn btn-xs btn-danger pull-right supprimer"\n                                        ng:click\x3d"effacer_devoir( devoir )"\n                                        ng:if\x3d"devoir.id \x26\x26 !creneau.etranger \x26\x26 !devoir.cours.deleted"\x3e\n                                    \x3cspan ng:if\x3d"!devoir.deleted"\x3e\x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e Supprimer\x3c/span\x3e\n                                    \x3cspan ng:if\x3d"devoir.deleted"\x3e\x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e Annuler la suppression\x3c/span\x3e\n                                \x3c/button\x3e\n                            \x3c/div\x3e\n\n                        \x3c/div\x3e\n                    \x3c/div\x3e\n                \x3c/div\x3e\n            \x3c/div\x3e\n\n        \x3c/uib-tab\x3e\n\n        \x3c!-- ####################### Devoirs d\u00fbs ce jour ####################### --\x3e\n        \x3cuib-tab\x3e\n            \x3cuib-tab-heading ng:class\x3d"{\'has\': devoirs.length \x3e 0}"\x3eTravail \u00e0 faire pour ce jour\x3c/uib-tab-heading\x3e\n\n            \x3cbutton class\x3d"btn btn-default ajout-devoir"\n                    ng:click\x3d"ajout_devoir( devoirs, creneau )"\n                    ng:if\x3d"creneau.can_add_homework"\x3e\n                \x3cspan class\x3d"glyphicon glyphicon-plus-sign"\x3e\x3c/span\x3e Ajouter un devoir\n            \x3c/button\x3e\n            \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n\n            \x3cdiv class\x3d"panel panel-default"\n                 ng:repeat\x3d"devoir in devoirs"\x3e\n\n                \x3cdiv class\x3d"row"\x3e\n                    \x3cdiv class\x3d"col-md-9"\n                         ng:if\x3d"!devoir.deleted"\x3e\n\n                        \x3cdiv class\x3d"panel-heading enseignant-saisie" ng:if\x3d"!creneau.etranger"\x3e\n                            \x3clabel class\x3d"col-md-12" ng:if\x3d"current_user.parametrage_cahier_de_textes.affichage_types_de_devoir"\x3eType de travail :\n                                \x3cselect ng:required\x3d"true"\n                                        ng:change\x3d"is_dirty( devoir )"\n                                        ng:model\x3d"devoir.type_devoir_id"\n                                        ng:options\x3d"type_de_devoir.id as type_de_devoir.description for type_de_devoir in types_de_devoir"\x3e\n                                \x3c/select\x3e\n                            \x3c/label\x3e\n\n                            \x3cdiv class\x3d"col-md-12"\x3e\n                                \x3clabel\x3eTemps de travail estim\u00e9 : \x3c/label\x3e\n                                \x3cspan uib-rating\n                                      ng:model\x3d"devoir.temps_estime"\n                                      max\x3d"15"\n                                      readonly\x3d"false"\n                                      ng:click\x3d"is_dirty( devoir )"\n                                      on-hover\x3d"estimation_over(devoir, value)"\n                                      on-leave\x3d"estimation_leave(devoir)"\n                                      state-on\x3d"\'temps-est-on\'"\n                                      state-off\x3d"\'temps-est-off\'"\x3e\x3c/span\x3e\n                                \x3cspan class\x3d"label pull-right"\n                                      ng:class\x3d"{\'label-success\': devoir.overValue\x3c4, \'label-info\': devoir.overValue\x3e\x3d4 \x26\x26 devoir.overValue\x3c8 , \'label-warning\': devoir.overValue\x3e\x3d8 \x26\x26 devoir.overValue\x3c12, \'label-danger\': devoir.overValue\x3e\x3d12}"\n                                      ng:if\x3d"devoir.overValue \x3e 0 || devoir.temps_estime \x3e 0"\x3e{{devoir.minutes || devoir.temps_estime * 5}} min\x3c/span\x3e\n                            \x3c/div\x3e\n                            \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n                        \x3c/div\x3e\n                        \x3ctext-angular class\x3d"panel-body"\n                                      ng:model\x3d"devoir.contenu"\n                                      ng:change\x3d"is_dirty( devoir )"\n                                      ng:if\x3d"!creneau.etranger"\x3e\x3c/text-angular\x3e\n\n                        \x3cdiv class\x3d"panel-heading enseignant-saisie" ng:if\x3d"creneau.etranger"\x3e\n                            \x3clabel\x3eType de travail : \x3cem\x3e{{devoir.type_devoir.description}}\x3c/em\x3e\x3c/label\x3e\n                            \x3clabel ng:if\x3d"devoir.temps_estime"\x3eTemps de travail estim\u00e9 : \x3cem\x3e{{devoir.temps_estime * 5}} min\x3c/em\x3e\x3c/label\x3e\n                        \x3c/div\x3e\n                        \x3cdiv class\x3d"panel-body" ng:bind-html\x3d"devoir.contenu" ng:if\x3d"creneau.etranger"\x3e\x3c/div\x3e\n\n                        \x3cdiv class\x3d"panel-footer ressources"\x3e\n                            \x3cdiv class\x3d"row"\x3e\n                                \x3cdiv class\x3d"attached-document" ng:repeat\x3d"ressource in devoir.ressources"\x3e\n                                    \x3ca target\x3d"_blank" href\x3d"{{ressource.url}}"\x3e{{ressource.name}}\x3c/a\x3e\n                                    \x3cbutton class\x3d"btn btn-sm btn-danger" ng:click\x3d"remove_ressource( devoir, ressource.hash )"\x3e\u2715\x3c/button\x3e\n                                \x3c/div\x3e\n                            \x3c/div\x3e\n\n                            \x3cdiv uib-dropdown class\x3d"uib-dropdown" ng:if\x3d"!creneau.etranger"\x3e\n                                \x3cbutton uib-dropdown-toggle class\x3d"btn btn-sm btn-default uib-dropdown-toggle pull-right" role\x3d"button" data-toggle\x3d"uib-dropdown" data-target\x3d"#" href\x3d""\n                                        ng:class\x3d"{\'disabled\': faulty_docs_app}"\x3e\n                                    \x3cspan class\x3d"glyphicon glyphicon-plus-sign"\x3e\x3c/span\x3e Ajouter une ressource\n                                \x3c/button\x3e\n                                \x3cdiv uib-dropdown-menu class\x3d"uib-dropdown-menu" role\x3d"menu" ng:click\x3d"$event.stopPropagation()"\x3e\n                                    \x3cdiv cartable\n                                         class\x3d"treecontrol-container"\n                                         racine\x3d"cartable.files"\n                                         target\x3d"devoir"\n                                         regroupement\x3d"selected_regroupement"\n                                         add-callback\x3d"consume_Documents_response_callback"\x3e\n                                    \x3c/div\x3e\n\n                                    \x3cinput type\x3d"file"\n                                           class\x3d"upload"\n                                           name\x3d"upload[]"\n                                           onchange\x3d"angular.element(this).scope().upload_and_add_ressource( angular.element(this).scope().devoir, this.files)" /\x3e\n                                \x3c/div\x3e\n                            \x3c/div\x3e\n                            \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n                        \x3c/div\x3e\n                    \x3c/div\x3e\n\n                    \x3cdiv class\x3d"col-md-3 infos"\n                         ng:if\x3d"!devoir.deleted"\x3e\n                        \x3cul class\x3d"pull-left"\x3e\n                            \x3cli class\x3d"clickable"\n                                ng:if\x3d"devoir.cours.contenu"\n                                uib-tooltip-html\x3d"devoir.cours.tooltip"\n                                tooltip-trigger\x3d"\'click\'"\n                                tooltip-placement\x3d"bottom"\x3e\n                                \x3cspan class\x3d"glyphicon glyphicon-briefcase"\x3e\x3c/span\x3e S\u00e9quence P\u00e9dagogique\n                            \x3c/li\x3e\n                        \x3c/ul\x3e\n                    \x3c/div\x3e\n\n                    \x3cdiv class\x3d"col-md-9 deleted"\n                         ng:if\x3d"devoir.deleted" \x3e(Devoir supprim\u00e9)\x3c/div\x3e\n\n                    \x3cdiv class\x3d"col-md-3"\x3e\n                        \x3cbutton type\x3d"button" class\x3d"btn btn-xs btn-danger pull-right supprimer"\n                                ng:click\x3d"effacer_devoir( devoir )"\n                                ng:if\x3d"devoir.id \x26\x26 !creneau.etranger \x26\x26 !devoir.cours.deleted"\x3e\n                            \x3cspan ng:if\x3d"!devoir.deleted"\x3e\x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e Supprimer\x3c/span\x3e\n                            \x3cspan ng:if\x3d"devoir.deleted"\x3e\x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e Annuler la suppression\x3c/span\x3e\n                        \x3c/button\x3e\n                    \x3c/div\x3e\n\n                \x3c/div\x3e\n            \x3c/div\x3e\n        \x3c/uib-tab\x3e\n\n    \x3c/uib-tabset\x3e\n    \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n\x3c/div\x3e\n\n\x3c!-- Duplication de S\u00e9quence P\u00e9dagogique --\x3e\n\x3cdiv class\x3d"modal-body" ng:if\x3d"mode_duplication"\x3e\n    \x3cdiv class\x3d"alert alert-success" role\x3d"alert" ng:if\x3d"creneaux_similaires.length \x3d\x3d 0"\x3ePlus aucune duplication possible\x3c/div\x3e\n    \x3cdiv class\x3d"duplication-saisie" ng:if\x3d"creneaux_similaires.length \x3e 0" \x3e\n        \x3cdiv class\x3d"col-md-12"\x3e\n            \x3col\x3e\n                \x3cli\x3e\n                    \x3clabel\x3eChoisir le cr\u00e9neau vers lequel copier la s\u00e9quence p\u00e9dagogique :\x3c/label\x3e\n                    \x3cul\x3e\n                        \x3cli ng:bind-html\x3d"cours.contenu"\x3e\x3c/li\x3e\n                    \x3c/ul\x3e\n                    \x3cselect class\x3d"col-md-3 pull-left"\n                            ng:model\x3d"scope.selected_regroupement_id_duplication"\n                            ng:options\x3d"classe.id as classe.name for classe in classes"\x3e\n                        \x3coption value\x3d"" selected\x3eToutes les classes\x3c/option\x3e\n                    \x3c/select\x3e\n                    \x3cselect ng:required\n                            ng:change\x3d"creneau_cible_duplication_SP_updated()"\n                            ng:model\x3d"creneaux_similaires.selected"\n                            ng:options\x3d"creneau as formateCreneau( creneau ) group by creneau.classe.name for creneau in creneaux_similaires | orderBy:[\'+start\'] | filter:selected_regroupement_id_duplication" \x3e\n                    \x3c/select\x3e\n                \x3c/li\x3e\n                \x3cli ng:if\x3d"cours.devoirs.length \x3e 0"\x3e\n                    \x3clabel\x3eChoisir le cr\u00e9neau vers lequel copier ses devoirs :\x3c/label\x3e\n                    \x3col\x3e\n                        \x3cli ng:repeat\x3d"devoir in cours.devoirs"\n                            ng:if\x3d"!devoir.deleted"\x3e\n                            \x3cul\x3e\n                                \x3cli ng:if\x3d"current_user.parametrage_cahier_de_textes.affichage_types_de_devoir"\x3e\x3ci class\x3d"picto" ng:style\x3d"{\'background-image\':\'url(\' + app_path + \'/app/vendor/laclasse-common-client/images/picto_devoir.svg)\'}"\x3e\x3c/i\x3e Type de devoir : \x3cem\x3e{{devoir.type_devoir.description}}\x3c/em\x3e\x3c/li\x3e\n                                \x3cli\x3eDate due : \x3cem\x3e{{devoir.date_due | amDateFormat : \'dddd D MMMM YYYY\'}}\x3c/em\x3e\x3c/li\x3e\n                                \x3cli ng:bind-html\x3d"devoir.contenu"\x3e\x3c/li\x3e\n                            \x3c/ul\x3e\n                            \x3cselect ng:change\x3d"are_we_go_for_duplication()"\n                                    ng:model\x3d"devoir.creneau_cible"\n                                    ng:options\x3d"creneau as formateCreneau( creneau ) for creneau in creneaux_devoirs_possibles_duplication | orderBy:\'date_due\'" \x3e\n                            \x3c/select\x3e\n                        \x3c/li\x3e\n                    \x3c/ol\x3e\n                \x3c/li\x3e\n            \x3c/ol\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"col-md-12 footer"\x3e\n            \x3cbutton type\x3d"button" class\x3d"btn btn-sm btn-success pull-right"\n                    ng:click\x3d"dupliquer()"\n                    ng:class\x3d"{ \'disabled\': !ok_go_for_duplication }"\x3e\n                \x3cspan\x3e\x3cspan class\x3d"glyphicon glyphicon-share"\x3e\x3c/span\x3e Dupliquer\x3c/span\x3e\n            \x3c/button\x3e\n        \x3c/div\x3e\n    \x3c/div\x3e\n    \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n\x3c/div\x3e\n\x3c!-- /Duplication de S\u00e9quence P\u00e9dagogique --\x3e\n\n\x3cdiv class\x3d"modal-footer"\x3e\n    \x3cbutton type\x3d"button" class\x3d"btn btn-sm btn-warning pull-left"\n            ng:if\x3d"!creneau.etranger \x26\x26 mode_edition_creneau \x26\x26 dirty"\n            ng:click\x3d"effacer_creneau()"\x3e\n        \x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e Supprimer le cr\u00e9neau\n    \x3c/button\x3e\n\n    \x3cbutton type\x3d"button" class\x3d"btn btn-sm btn-default pull-left"\n            ng:click\x3d"switch_to_creneau_edition()"\n            ng:if\x3d"!creneau.etranger \x26\x26 !mode_edition_creneau" \x3e\n        \x3cspan\x3e\x3cspan class\x3d"glyphicon glyphicon-edit"\x3e\x3c/span\x3e Modifier le cr\u00e9neau\x3c/span\x3e\n    \x3c/button\x3e\n\n    \x3cbutton type\x3d"button" class\x3d"btn btn-sm btn-default pull-left"\n            ng:click\x3d"switch_to_duplication_mode()"\n            ng:if\x3d"!creneau.etranger \x26\x26 cours.contenu \x26\x26 !mode_edition_creneau \x26\x26 !mode_duplication \x26\x26 creneaux_similaires.length \x3e 0 \x26\x26 !dirty" \x3e\n        \x3cspan\x3e\x3cspan class\x3d"glyphicon glyphicon-transfer"\x3e\x3c/span\x3e Copier \u00e0 d\'autres cr\u00e9neaux\x3c/span\x3e\n    \x3c/button\x3e\n\n    \x3cbutton type\x3d"button" class\x3d"btn btn-sm btn-default"\n            ng:click\x3d"switch_to_modification_mode()"\n            ng:if\x3d"mode_duplication || mode_edition_creneau \x26\x26 !creneau.en_creation" \x3e\n        \x3cspan\x3e\x3cspan class\x3d"glyphicon glyphicon-transfer"\x3e\x3c/span\x3e Revenir en modification\x3c/span\x3e\n    \x3c/button\x3e\n\n    \x3cbutton type\x3d"button" class\x3d"btn btn-sm btn-success pull-right" ng:click\x3d"valider()" ng:if\x3d"!creneau.etranger \x26\x26 dirty || (mode_edition_creneau \x26\x26 scope.selected_regroupement)"\x3e\n        \x3cspan class\x3d"glyphicon glyphicon-ok-sign"\x3e\x3c/span\x3e Valider\n    \x3c/button\x3e\n    \x3cbutton type\x3d"button" class\x3d"btn btn-sm btn-default pull-right" ng:click\x3d"annuler()"\x3e\n        \x3cspan class\x3d"glyphicon glyphicon-remove-sign"\x3e\x3c/span\x3e\n        \x3cspan ng:if\x3d"dirty || mode_edition_creneau"\x3e Annuler\x3c/span\x3e\n        \x3cspan ng:if\x3d"!dirty \x26\x26 !mode_edition_creneau"\x3e Fermer\x3c/span\x3e\n    \x3c/button\x3e\n\x3c/div\x3e\n')}]);
angular.module("cahierDeTextesClientApp").run(["$templateCache",function(a){a.put("views/textbook.html",'\x3cdiv class\x3d"panel panel-default"\x3e\n    \x3cdiv class\x3d"panel-heading" ng:if\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'ENS\' || current_user.profil_actif.type \x3d\x3d\x3d \'EVS\' || current_user.profil_actif.type \x3d\x3d\x3d \'DIR\' || current_user.profil_actif.type \x3d\x3d\x3d \'ADM\' || current_user.profil_actif.type \x3d\x3d\x3d \'DOC\'"\x3e\n\n        \x3cdiv class\x3d"ui-select-wrapper"\x3e\n            \x3cui-select multiple class\x3d"pull-left" theme\x3d"bootstrap"\n                       append-to-body\x3d"true"\n                       ng:change\x3d"refresh_calendar()"\n                       ng:model\x3d"scope.selected_regroupements"\x3e\n                \x3cui-select-match placeholder\x3d"Regroupement(s)..."\x3e\n                    \x3cspan class\x3d"label" ng:class\x3d"{\'label-success\': $item.type \x3d\x3d\x3d \'GRP\', \'label-info\': $item.type \x3d\x3d\x3d \'CLS\', \'label-warning\': $item.type \x3d\x3d\x3d \'GPL\' }"\x3e\n                        {{$item.name}}\n                    \x3c/span\x3e\n                \x3c/ui-select-match\x3e\n                \x3cui-select-choices repeat\x3d"classe in current_user.actual_groups | orderBy:[\'type\',\'name\']"\n                                   group-by\x3d"\'full_type\'"\x3e\n                    \x3cspan class\x3d"label" ng:class\x3d"{\'label-success\': classe.type \x3d\x3d\x3d \'GRP\', \'label-info\': classe.type \x3d\x3d\x3d \'CLS\', \'label-warning\': classe.type \x3d\x3d\x3d \'GPL\' }"\x3e\n                        {{classe.name}}\n                    \x3c/span\x3e\n                \x3c/ui-select-choices\x3e\n            \x3c/ui-select\x3e\n            \x3cbutton class\x3d"btn btn-xs btn-primary"\n                    ng:click\x3d"select_all_regroupements()"\x3e\x3cspan class\x3d"glyphicon glyphicon-certificate"\x3e\x3c/span\x3e\x3c/button\x3e\n            \x3cbutton class\x3d"btn btn-xs btn-default"\n                    ng:click\x3d"select_no_regroupements()"\x3e\x3cspan class\x3d"glyphicon glyphicon-erase"\x3e\x3c/span\x3e\x3c/button\x3e\n        \x3c/div\x3e\n\n        \x3cdiv class\x3d"pull-right options" ng:if\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'ENS\' || current_user.profil_actif.type \x3d\x3d\x3d \'DOC\'"\x3e\n            \x3clabel\x3e\x3ccheckbox class\x3d"btn-info" ng:model\x3d"scope.uniquement_mes_creneaux"\n                             ng:change\x3d"refresh_calendar()"\x3e\x3c/checkbox\x3e Ne montrer que ce qui me concerne directement\x3c/label\x3e\n        \x3c/div\x3e\n        \x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n    \x3c/div\x3e\n    \x3cdiv class\x3d"panel-body"\n         ng:class\x3d"{\'vacances\': c_est_les_vacances}"\x3e\n        \x3cdiv data-calendar\x3d"emploi_du_temps"\n             id\x3d"emploi_du_temps"\n             data-ui-calendar\x3d"calendar.options"\n             class\x3d"calendar"\n             ng:model\x3d"calendar.events"\n             calendar-watch-event\x3d"extraEventSignature"\n             ng:swipe-left\x3d"next()"\n             ng:swipe-right\x3d"prev()"\x3e\x3c/div\x3e\n        \x3cdiv class\x3d"col-md-12"\x3e\n            \x3cdiv class\x3d"pull-right legende"\x3e\n                \x3clabel\x3eL\u00e9gende :\x3c/label\x3e\n                \x3clabel\x3e\x3cspan class\x3d"label edt-cours" title\x3d"Cours"\x3e \x3c/span\x3e Cours\x3c/label\x3e\n                \x3c!-- \x3cspan class\x3d"label edt-permanence" title\x3d"Permanence"\x3e \x3c/span\x3e Permanence --\x3e\n                \x3clabel\x3e\x3cspan class\x3d"label edt-devoir-a-faire" title\x3d"Devoir \u00e0 faire"\x3e \x3c/span\x3e Devoir \u00e0 faire\x3c/label\x3e\n                \x3clabel ng:if\x3d"current_user.profil_actif.type \x3d\x3d\x3d \'ELV\'"\x3e\x3cspan class\x3d"label edt-devoir-fait" title\x3d"Devoir fait ! Youpi !"\x3e \x3c/span\x3e Devoir fait\x3c/label\x3e\n                \x3clabel\x3e\x3cspan class\x3d"label edt-devoir-note-maison" title\x3d"Devoir \u00e0 faire \u00e0 la maison"\x3e \x3c/span\x3e DM - devoir maison\x3c/label\x3e\n                \x3clabel\x3e\x3cspan class\x3d"label edt-devoir-note-surveille" title\x3d"Devoir surveill\u00e9"\x3e \x3c/span\x3e DS - devoir surveill\u00e9\x3c/label\x3e\n            \x3c/div\x3e\n        \x3c/div\x3e\n    \x3c/div\x3e\n\x3c/div\x3e\n')}]);
