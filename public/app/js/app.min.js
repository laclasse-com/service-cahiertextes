...
"/api/structures/"+b)});e.get_group=_.memoize(function(e){return a.get(d+"/api/groups/"+e+"?expand\x3dfalse").then(function(a){a.data.full_type=c(a.data.type);return b.resolve(a)})});e.get_groups=_.memoize(function(e){return _(e).isEmpty()?b.resolve({data:[]}):a.get(d+"/api/groups/",{params:{"id[]":e}}).then(function(a){a.data=a.data.map(function(a){a.full_type=c(a.type);return a});return b.resolve(a)})});e.get_groups_of_structures=_.memoize(function(e){return a.get(d+"/api/groups/",{params:{"structure_id[]":e}}).then(function(a){a.data=
